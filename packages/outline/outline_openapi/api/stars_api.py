...
class StarsApi:
    ...
    async def stars_create(
        self,
        stars_create_request: Optional[StarsCreateRequest] = None,
        ...
        :param stars_create_request:
        :type stars_create_request: StarsCreateRequest
        ...
        _param = self._stars_create_serialize(
            stars_create_request=stars_create_request,
    ...
    @validate_call
    async def stars_create_with_http_info(
        self,
        stars_create_request: Optional[StarsCreateRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StarsCreate200Response]:
        """Create a star
    ...
    @validate_call
    async def stars_create_without_preload_content(
        self,
        stars_create_request: Optional[StarsCreateRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _stars_create_serialize(
        self,
        stars_create_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if stars_create_request is not None:
            _body_params = stars_create_request
    ...
    async def stars_delete(
        ...
        _param = self._stars_delete_serialize(
    ...
    @validate_call
    async def stars_delete_with_http_info(
        self,
        collections_delete_request: Optional[CollectionsDeleteRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def stars_delete_without_preload_content(
        self,
        collections_delete_request: Optional[CollectionsDeleteRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def stars_list_with_http_info(
        self,
        pagination: Optional[Pagination] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StarsList200Response]:
        """List all stars
    ...
    @validate_call
    async def stars_list_without_preload_content(
        self,
        pagination: Optional[Pagination] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def stars_update(
        self,
        stars_update_request: Optional[StarsUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param stars_update_request:
        :type stars_update_request: StarsUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stars_update_serialize(
            stars_update_request=stars_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def stars_update_with_http_info(
        self,
        stars_update_request: Optional[StarsUpdateRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def stars_update_without_preload_content(
        self,
        stars_update_request: Optional[StarsUpdateRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _stars_update_serialize(
        self,
        stars_update_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if stars_update_request is not None:
            _body_params = stars_update_request
