...
class CommentsApi:
    ...
    async def comments_create(
        self,
        comments_create_request: Optional[CommentsCreateRequest] = None,
        ...
        :param comments_create_request:
        :type comments_create_request: CommentsCreateRequest
        ...
        _param = self._comments_create_serialize(
            comments_create_request=comments_create_request,
    ...
    async def comments_create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentsCreate200Response]:
        """Create a comment
    ...
    def _comments_create_serialize(
        ...
        if comments_create_request is not None:
            _body_params = comments_create_request
    ...
    async def comments_delete(
        ...
        _param = self._comments_delete_serialize(
    ...
    @validate_call
    async def comments_delete_with_http_info(
        self,
        collections_delete_request: Optional[CollectionsDeleteRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def comments_delete_without_preload_content(
        self,
        collections_delete_request: Optional[CollectionsDeleteRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_delete_serialize(
        self,
    ...
    async def comments_info(
        self,
        comments_info_request: Optional[CommentsInfoRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param comments_info_request:
        :type comments_info_request: CommentsInfoRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._comments_info_serialize(
            comments_info_request=comments_info_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def comments_info_with_http_info(
        self,
        comments_info_request: Optional[CommentsInfoRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentsInfo200Response]:
        """Retrieve a comment
    ...
    @validate_call
    async def comments_info_without_preload_content(
        self,
        comments_info_request: Optional[CommentsInfoRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _comments_info_serialize(
        self,
        comments_info_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if comments_info_request is not None:
            _body_params = comments_info_request
    ...
    async def comments_list(
        self,
        comments_list_request: Optional[CommentsListRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param comments_list_request:
        :type comments_list_request: CommentsListRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    async def comments_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommentsList200Response]:
        """List all comments
    ...
    def _comments_list_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if comments_list_request is not None:
            _body_params = comments_list_request
    ...
    async def comments_update(
        self,
        comments_update_request: Optional[CommentsUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param comments_update_request:
        :type comments_update_request: CommentsUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._comments_update_serialize(
            comments_update_request=comments_update_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _comments_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if comments_update_request is not None:
            _body_params = comments_update_request
