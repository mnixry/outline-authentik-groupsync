...
class ViewsApi:
    ...
    async def views_create(
        ...
        _param = self._views_create_serialize(
    ...
    @validate_call
    async def views_create_with_http_info(
        self,
        shares_create_request: Optional[SharesCreateRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ViewsCreate200Response]:
        """Create a view
    ...
    @validate_call
    async def views_create_without_preload_content(
        self,
        shares_create_request: Optional[SharesCreateRequest] = None,
        _request_timeout: Union[
            None,
    ...
    async def views_list(
        self,
        views_list_request: Optional[ViewsListRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param views_list_request:
        :type views_list_request: ViewsListRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._views_list_serialize(
            views_list_request=views_list_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def views_list_with_http_info(
        self,
        views_list_request: Optional[ViewsListRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ViewsList200Response]:
        """List all views
    ...
    @validate_call
    async def views_list_without_preload_content(
        self,
        views_list_request: Optional[ViewsListRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _views_list_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if views_list_request is not None:
            _body_params = views_list_request
