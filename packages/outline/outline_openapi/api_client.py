...
from outline_openapi.api_response import ApiResponse, T as ApiResponseT
import outline_openapi.models
from outline_openapi import rest
from outline_openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(outline_openapi.models, klass)
