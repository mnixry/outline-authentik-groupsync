...
class SharesListRequest(BaseModel):
    """
    SharesListRequest
    """ # noqa: E501
    ...
    query: Optional[StrictStr] = Field(default=None, description="Filter to shared documents matching a search query")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "query"]
