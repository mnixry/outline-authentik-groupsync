...
class FileoperationsListRequest(BaseModel):
    """
    ...
    type: StrictStr = Field(description="The type of fileOperation")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "type"]
