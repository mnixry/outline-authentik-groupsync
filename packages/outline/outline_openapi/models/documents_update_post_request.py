...
class DocumentsUpdatePostRequest(BaseModel):
    """
    ...
    text: Optional[StrictStr] = Field(default=None, description="The body of the document, may contain markdown formatting.")
