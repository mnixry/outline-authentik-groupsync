...
class AttachmentsCreateRequest(BaseModel):
    """
    ...
    size: Union[StrictFloat, StrictInt] = Field(description="Size of the file attachment in bytes.")
    __properties: ClassVar[List[str]] = ["name", "documentId", "contentType", "size"]
