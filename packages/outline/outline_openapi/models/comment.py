...
class Comment(BaseModel):
    ...
    anchor_text: Optional[StrictStr] = Field(default=None, description="The document text that the comment is anchored to, only included if includeAnchorText=true.", alias="anchorText")
    __properties: ClassVar[List[str]] = ["id", "data", "documentId", "parentCommentId", "createdAt", "createdBy", "updatedAt", "updatedBy", "anchorText"]
