...
class StarsList200ResponseData(BaseModel):
    """
    StarsList200ResponseData
    """ # noqa: E501
    stars: Optional[List[Star]] = None
    documents: Optional[List[Document]] = None
    __properties: ClassVar[List[str]] = ["stars", "documents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stars": [Star.from_dict(_item) for _item in obj["stars"]] if obj.get("stars") is not None else None,
