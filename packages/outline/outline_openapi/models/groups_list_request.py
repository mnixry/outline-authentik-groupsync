...
class GroupsListRequest(BaseModel):
    """
    GroupsListRequest
    """ # noqa: E501
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Filter to groups including a specific user", alias="userId")
    external_id: Optional[StrictStr] = Field(default=None, description="Filter to groups matching an external ID", alias="externalId")
    query: Optional[StrictStr] = Field(default=None, description="Filter to groups matching a search query")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "userId", "externalId", "query"]
