...
class GroupsMemberships200Response(BaseModel):
    """
    GroupsMemberships200Response
    """ # noqa: E501
    data: Optional[GroupsMemberships200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GroupsMemberships200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
