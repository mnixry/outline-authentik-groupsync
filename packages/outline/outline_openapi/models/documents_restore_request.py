...
class DocumentsRestoreRequest(BaseModel):
    """
    ...
    revision_id: Optional[StrictStr] = Field(default=None, description="Identifier for the revision to restore to.", alias="revisionId")
    __properties: ClassVar[List[str]] = ["id", "revisionId"]
