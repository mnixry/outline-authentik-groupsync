...
class OauthClientsList200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "data", "policies", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [OAuthClient.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
