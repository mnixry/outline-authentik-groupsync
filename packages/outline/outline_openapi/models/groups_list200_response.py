...
class GroupsList200Response(BaseModel):
    """
    GroupsList200Response
    """ # noqa: E501
    data: Optional[GroupsList200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GroupsList200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
