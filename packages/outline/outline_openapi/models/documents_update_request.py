...
class DocumentsUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the document. Either the UUID or the urlId is acceptable.")
    title: Optional[StrictStr] = Field(default=None, description="The title of the document.")
    text: Optional[StrictStr] = Field(default=None, description="The body of the document in markdown.")
    append: Optional[StrictBool] = Field(default=None, description="If true the text field will be appended to the end of the existing document, rather than the default behavior of replacing it. This is potentially useful for things like logging into a document.")
    publish: Optional[StrictBool] = Field(default=None, description="Whether this document should be published and made visible to other team members, if a draft")
    done: Optional[StrictBool] = Field(default=None, description="Whether the editing session has finished, this will trigger any notifications. This property will soon be deprecated.")
    __properties: ClassVar[List[str]] = ["id", "title", "text", "append", "publish", "done"]
