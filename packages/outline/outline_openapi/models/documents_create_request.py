...
class DocumentsCreateRequest(BaseModel):
    ...
    template: Optional[StrictBool] = Field(default=None, description="Whether this document should be considered to be a template.")
    publish: Optional[StrictBool] = Field(default=None, description="Whether this document should be immediately published and made visible to other team members.")
    __properties: ClassVar[List[str]] = ["title", "text", "collectionId", "parentDocumentId", "templateId", "template", "publish"]
