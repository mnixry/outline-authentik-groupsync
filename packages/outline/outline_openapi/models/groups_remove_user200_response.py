...
class GroupsRemoveUser200Response(BaseModel):
    """
    GroupsRemoveUser200Response
    """ # noqa: E501
    data: Optional[GroupsRemoveUser200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GroupsRemoveUser200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
