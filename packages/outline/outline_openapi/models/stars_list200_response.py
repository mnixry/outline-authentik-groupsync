...
class StarsList200Response(BaseModel):
    """
    StarsList200Response
    """ # noqa: E501
    data: Optional[StarsList200ResponseData] = None
    pagination: Optional[Pagination] = None
    policies: Optional[List[Policy]] = None
    __properties: ClassVar[List[str]] = ["data", "pagination", "policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": StarsList200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
