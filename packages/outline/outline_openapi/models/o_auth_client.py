...
class OAuthClient(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of this OAuth client.")
    description: Optional[StrictStr] = Field(default=None, description="A short description of this OAuth client.")
    developer_name: Optional[StrictStr] = Field(default=None, description="The name of the developer who created this OAuth client.", alias="developerName")
    developer_url: Optional[StrictStr] = Field(default=None, description="The URL of the developer who created this OAuth client.", alias="developerUrl")
    avatar_url: Optional[StrictStr] = Field(default=None, description="A URL pointing to an image representing the OAuth client.", alias="avatarUrl")
    client_id: Optional[StrictStr] = Field(default=None, description="The client ID for the OAuth client.", alias="clientId")
    client_secret: Optional[StrictStr] = Field(default=None, description="The client secret for the OAuth client.", alias="clientSecret")
    redirect_uris: Optional[List[StrictStr]] = Field(default=None, description="The redirect URIs for the OAuth client.", alias="redirectUris")
    published: Optional[StrictBool] = Field(default=None, description="Whether the OAuth client is available to other workspaces.")
    created_at: Optional[datetime] = Field(default=None, description="Date and time when this OAuth client was created", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="Date and time when this OAuth client was updated", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "developerName", "developerUrl", "avatarUrl", "clientId", "clientSecret", "redirectUris", "published", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "developerUrl": obj.get("developerUrl"),
