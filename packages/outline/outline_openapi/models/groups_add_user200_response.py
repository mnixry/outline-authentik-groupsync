...
class GroupsAddUser200Response(BaseModel):
    """
    GroupsAddUser200Response
    """ # noqa: E501
    data: Optional[GroupsAddUser200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": GroupsAddUser200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
