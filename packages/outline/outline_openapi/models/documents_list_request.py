...
class DocumentsListRequest(BaseModel):
    ...
    collection_id: Optional[StrictStr] = Field(default=None, description="Optionally filter to a specific collection", alias="collectionId")
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    backlink_document_id: Optional[StrictStr] = Field(default=None, alias="backlinkDocumentId")
    parent_document_id: Optional[StrictStr] = Field(default=None, alias="parentDocumentId")
    template: Optional[StrictBool] = Field(default=None, description="Optionally filter to only templates")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "collectionId", "userId", "backlinkDocumentId", "parentDocumentId", "template"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "backlinkDocumentId": obj.get("backlinkDocumentId"),
