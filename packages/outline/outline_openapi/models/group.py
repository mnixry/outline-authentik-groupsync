...
class Group(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of this group.")
    member_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of users that are members of the group", alias="memberCount")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "memberCount", "createdAt", "updatedAt"]
