...
class AttachmentsCreate200Response(BaseModel):
    """
    AttachmentsCreate200Response
    """ # noqa: E501
    data: Optional[AttachmentsCreate200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AttachmentsCreate200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
