...
class SharesInfoRequest(BaseModel):
    """
    SharesInfoRequest
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the share.")
    document_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for a document. One of id or documentId must be provided.", alias="documentId")
    __properties: ClassVar[List[str]] = ["id", "documentId"]
