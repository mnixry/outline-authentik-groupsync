...
class CollectionsGroupMemberships200ResponseData(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.collection_group_memberships:
            for _item_collection_group_memberships in self.collection_group_memberships:
                if _item_collection_group_memberships:
                    _items.append(_item_collection_group_memberships.to_dict())
