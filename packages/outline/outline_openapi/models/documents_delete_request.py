...
class DocumentsDeleteRequest(BaseModel):
    ...
    permanent: Optional[StrictBool] = Field(default=None, description="If set to true the document will be destroyed with no way to recover rather than moved to the trash.")
    __properties: ClassVar[List[str]] = ["id", "permanent"]
