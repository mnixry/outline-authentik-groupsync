...
class Collection(Model):
    ...
    def __init__(self, id: str=None, name: str=None, description: str=None, sort: CollectionSort=None, index: str=None, color: str=None, icon: str=None, permission: Permission=None, created_at: datetime=None, updated_at: datetime=None, deleted_at: datetime=None):
        ...
        :param sort: The sort of this Collection.
        :param index: The index of this Collection.
        :param color: The color of this Collection.
        :param icon: The icon of this Collection.
        :param permission: The permission of this Collection.
        :param created_at: The created_at of this Collection.
        :param updated_at: The updated_at of this Collection.
        :param deleted_at: The deleted_at of this Collection.
        """
        self.openapi_types = {
            'id': str,
            'name': str,
    ...
    @property
    def sort(self):
        """Gets the sort of this Collection.


        :return: The sort of this Collection.
    ...
    @property
    def index(self):
        """Gets the index of this Collection.

        The position of the collection in the sidebar

        :return: The index of this Collection.
        :rtype: str
        """
        return self._index
    ...
    def color(self):
        ...
        :return: The color of this Collection.
        :rtype: str
        """
        return self._color
    ...
    @property
    def icon(self):
        """Gets the icon of this Collection.

        A string that represents an icon in the outline-icons package

        :return: The icon of this Collection.
        :rtype: str
        """
        return self._icon
    ...
    @property
    def permission(self):
        """Gets the permission of this Collection.


        :return: The permission of this Collection.
        :rtype: Permission
        """
    ...
    @property
    def deleted_at(self):
        """Gets the deleted_at of this Collection.

        The date and time that this object was deleted

        :return: The deleted_at of this Collection.
        :rtype: datetime
        """
