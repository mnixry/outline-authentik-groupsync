...
class RevisionsListRequest(BaseModel):
    ...
    document_id: Optional[StrictStr] = Field(default=None, description="The document ID to retrieve revisions for", alias="documentId")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "documentId"]
