...
class AuthConfig200ResponseData(BaseModel):
    """
    AuthConfig200ResponseData
    """ # noqa: E501
    name: Optional[StrictStr] = None
    hostname: Optional[StrictStr] = None
    services: Optional[List[AuthConfig200ResponseDataServicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [AuthConfig200ResponseDataServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
