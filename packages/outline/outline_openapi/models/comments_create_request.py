...
class CommentsCreateRequest(BaseModel):
    ...
    data: Optional[Dict[str, Any]] = Field(default=None, description="The body of the comment.")
    text: Optional[StrictStr] = Field(default=None, description="The body of the comment in markdown.")
    __properties: ClassVar[List[str]] = ["id", "documentId", "parentCommentId", "data", "text"]
