...
class DocumentsAnswerquestion200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["documents", "policies", "search"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "search": SearchResult.from_dict(obj["search"]) if obj.get("search") is not None else None
        })
        return _obj
