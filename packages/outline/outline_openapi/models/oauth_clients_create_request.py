...
class OauthClientsCreateRequest(BaseModel):
    """
    ...
    redirect_uris: List[StrictStr] = Field(description="List of redirect URIs for the OAuth client.", alias="redirectUris")
    published: Optional[StrictBool] = Field(default=None, description="Whether the OAuth client is available to other workspaces.")
    __properties: ClassVar[List[str]] = ["name", "description", "developerName", "developerUrl", "avatarUrl", "redirectUris", "published"]
