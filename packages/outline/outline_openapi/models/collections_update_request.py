...
class CollectionsUpdateRequest(BaseModel):
    """
    CollectionsUpdateRequest
    """ # noqa: E501
    id: StrictStr
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = Field(default=None, description="A brief description of the collection, markdown supported.")
    ...
    color: Optional[StrictStr] = Field(default=None, description="A hex color code for the collection icon")
    sharing: Optional[StrictBool] = Field(default=None, description="Whether public sharing of documents is allowed")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "permission", "icon", "color", "sharing"]
