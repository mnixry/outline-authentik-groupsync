...
class OauthClientsInfoRequest(BaseModel):
    """
    OauthClientsInfoRequest
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the OAuth client.")
    client_id: Optional[StrictStr] = Field(default=None, description="Public identifier for the OAuth client.", alias="clientId")
    __properties: ClassVar[List[str]] = ["id", "clientId"]
