...
class Star(BaseModel):
    ...
    index: Optional[StrictStr] = Field(default=None, description="Index of the star in the list of stars.")
    document_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the starred document.", alias="documentId")
    collection_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the starred collection.", alias="collectionId")
    document_url: Optional[StrictStr] = Field(default=None, description="URL of the original document.", alias="documentUrl")
    created_at: Optional[datetime] = Field(default=None, description="Date and time when this star was created", alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "index", "documentId", "collectionId", "documentUrl", "createdAt"]
