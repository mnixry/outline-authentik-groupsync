...
class OauthClientsUpdateRequest(BaseModel):
    """
    OauthClientsUpdateRequest
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the OAuth client.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the OAuth client.")
    ...
    redirect_uris: Optional[List[StrictStr]] = Field(default=None, description="List of redirect URIs for the OAuth client.", alias="redirectUris")
    published: Optional[StrictBool] = Field(default=None, description="Whether the OAuth client is available to other workspaces.")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "developerName", "developerUrl", "avatarUrl", "redirectUris", "published"]
