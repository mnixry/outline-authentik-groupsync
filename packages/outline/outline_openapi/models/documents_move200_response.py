...
class DocumentsMove200Response(BaseModel):
    """
    DocumentsMove200Response
    """ # noqa: E501
    data: Optional[DocumentsMove200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": DocumentsMove200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
