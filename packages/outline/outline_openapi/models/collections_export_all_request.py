...
class CollectionsExportAllRequest(BaseModel):
    """
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(['outline-markdown', 'json', 'html']):
            raise ValueError("must be one of enum values ('outline-markdown', 'json', 'html')")
        return value
