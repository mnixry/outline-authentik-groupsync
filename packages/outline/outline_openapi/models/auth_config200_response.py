...
class AuthConfig200Response(BaseModel):
    """
    AuthConfig200Response
    """ # noqa: E501
    data: Optional[AuthConfig200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": AuthConfig200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
