...
class PolicyAbilities(BaseModel):
    ...
    star: Optional[StrictBool] = None
    unstar: Optional[StrictBool] = None
    share: Optional[StrictBool] = None
    download: Optional[StrictBool] = None
    pin: Optional[StrictBool] = None
    unpin: Optional[StrictBool] = None
    move: Optional[StrictBool] = None
    archive: Optional[StrictBool] = None
    unarchive: Optional[StrictBool] = None
    create_child_document: Optional[StrictBool] = Field(default=None, alias="createChildDocument")
    __properties: ClassVar[List[str]] = ["create", "read", "update", "delete", "restore", "star", "unstar", "share", "download", "pin", "unpin", "move", "archive", "unarchive", "createChildDocument"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unarchive": obj.get("unarchive"),
            "createChildDocument": obj.get("createChildDocument")
        })
        return _obj
