...
class EventsListRequest(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Filter to a specific event, e.g. \"collections.create\". Event names are in the format \"objects.verb\"")
    actor_id: Optional[StrictStr] = Field(default=None, description="Filter to events performed by the selected user", alias="actorId")
    document_id: Optional[StrictStr] = Field(default=None, description="Filter to events performed in the selected document", alias="documentId")
    collection_id: Optional[StrictStr] = Field(default=None, description="Filter to events performed in the selected collection", alias="collectionId")
    audit_log: Optional[StrictBool] = Field(default=None, description="Whether to return detailed events suitable for an audit log. Without this flag less detailed event types will be returned.", alias="auditLog")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "name", "actorId", "documentId", "collectionId", "auditLog"]
