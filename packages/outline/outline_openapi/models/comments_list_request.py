...
class CommentsListRequest(BaseModel):
    ...
    document_id: Optional[StrictStr] = Field(default=None, description="Filter to a specific document", alias="documentId")
    collection_id: Optional[StrictStr] = Field(default=None, description="Filter to a specific collection", alias="collectionId")
    include_anchor_text: Optional[StrictBool] = Field(default=None, description="Include the document text that the comment is anchored to, if any, in the response.", alias="includeAnchorText")
    __properties: ClassVar[List[str]] = ["offset", "limit", "sort", "direction", "documentId", "collectionId", "includeAnchorText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeAnchorText": obj.get("includeAnchorText")
        })
        return _obj
