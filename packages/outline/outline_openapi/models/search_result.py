...
class SearchResult(BaseModel):
    ...
    query: Optional[StrictStr] = Field(default=None, description="The user-provided search query")
    answer: Optional[StrictStr] = Field(default=None, description="An answer to the query, if possible")
    source: Optional[StrictStr] = Field(default=None, description="The source of the query")
    ...
    __properties: ClassVar[List[str]] = ["id", "query", "answer", "source", "createdAt"]
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['api', 'app']):
            raise ValueError("must be one of enum values ('api', 'app')")
        return value
