...
class CollectionsMemberships200Response(BaseModel):
    """
    CollectionsMemberships200Response
    """ # noqa: E501
    data: Optional[CollectionsAddUser200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CollectionsAddUser200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
