...
class TestUsersInvitePost200ResponseData(unittest.TestCase):
    """UsersInvitePost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInvitePost200ResponseData:
        """Test UsersInvitePost200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInvitePost200ResponseData`
        """
        model = UsersInvitePost200ResponseData()
        if include_optional:
            return UsersInvitePost200ResponseData(
                sent = [
    ...
    def testUsersInvitePost200ResponseData(self):
        """Test UsersInvitePost200ResponseData"""
