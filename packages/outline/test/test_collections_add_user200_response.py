...
class TestCollectionsAddUser200Response(unittest.TestCase):
    """CollectionsAddUser200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddUser200Response:
        """Test CollectionsAddUser200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddUser200Response`
        """
        model = CollectionsAddUser200Response()
        if include_optional:
            return CollectionsAddUser200Response(
    ...
    def testCollectionsAddUser200Response(self):
        """Test CollectionsAddUser200Response"""
