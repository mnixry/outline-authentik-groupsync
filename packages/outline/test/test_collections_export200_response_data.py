...
class TestCollectionsExport200ResponseData(unittest.TestCase):
    """CollectionsExport200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExport200ResponseData:
        """Test CollectionsExport200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExport200ResponseData`
        """
        model = CollectionsExport200ResponseData()
        if include_optional:
            return CollectionsExport200ResponseData(
    ...
    def testCollectionsExport200ResponseData(self):
        """Test CollectionsExport200ResponseData"""
