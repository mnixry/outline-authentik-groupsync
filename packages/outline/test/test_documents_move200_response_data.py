...
class TestDocumentsMove200ResponseData(unittest.TestCase):
    """DocumentsMove200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMove200ResponseData:
        """Test DocumentsMove200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMove200ResponseData`
        """
        model = DocumentsMove200ResponseData()
        if include_optional:
            return DocumentsMove200ResponseData(
                documents = [
                ...
                collections = [
                    outline_openapi.models.collection.Collection(
                        ...
                        deleted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        archived_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        archived_by = outline_openapi.models.user.User(
                            id = '', 
                            name = 'Jane Doe', 
                            avatar_url = '', 
                            email = '', 
    ...
    def testDocumentsMove200ResponseData(self):
        """Test DocumentsMove200ResponseData"""
