...
class TestGroupsListRequest(unittest.TestCase):
    """GroupsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsListRequest:
        """Test GroupsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsListRequest`
        """
        model = GroupsListRequest()
        if include_optional:
    ...
    def testGroupsListRequest(self):
        """Test GroupsListRequest"""
