...
class TestOauthClientsInfo200Response(unittest.TestCase):
    """OauthClientsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsInfo200Response:
        """Test OauthClientsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsInfo200Response`
        """
        model = OauthClientsInfo200Response()
        if include_optional:
            return OauthClientsInfo200Response(
                data = outline_openapi.models.o_auth_client.OAuthClient(
                    id = '', 
                    name = 'Acme Inc', 
    ...
    def testOauthClientsInfo200Response(self):
        """Test OauthClientsInfo200Response"""
