...
class TestDocumentsUsersRequest(unittest.TestCase):
    """DocumentsUsersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUsersRequest:
        """Test DocumentsUsersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUsersRequest`
        """
        model = DocumentsUsersRequest()
        if include_optional:
            return DocumentsUsersRequest(
                id = 'hDYep1TPAM',
                query = ''
            )
        else:
    ...
    def testDocumentsUsersRequest(self):
        """Test DocumentsUsersRequest"""
