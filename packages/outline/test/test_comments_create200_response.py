...
class TestCommentsCreate200Response(unittest.TestCase):
    """CommentsCreate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsCreate200Response:
        """Test CommentsCreate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsCreate200Response`
        """
        model = CommentsCreate200Response()
        if include_optional:
            return CommentsCreate200Response(
                data = outline_openapi.models.comment.Comment(
                    id = '', 
    ...
    def testCommentsCreate200Response(self):
        """Test CommentsCreate200Response"""
