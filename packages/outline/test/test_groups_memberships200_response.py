...
class TestGroupsMemberships200Response(unittest.TestCase):
    """GroupsMemberships200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsMemberships200Response:
        """Test GroupsMemberships200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsMemberships200Response`
        """
        model = GroupsMemberships200Response()
        if include_optional:
            return GroupsMemberships200Response(
                data = outline_openapi.models.groups_memberships_200_response_data.groupsMemberships_200_response_data(
                    users = [
                    ...
                    group_memberships = [
                        outline_openapi.models.group_membership.GroupMembership(
                            id = '', 
                            group_id = '', 
                            user_id = '', 
                            user = outline_openapi.models.user.User(
                                id = '', 
                                name = 'Jane Doe', 
                                avatar_url = '', 
                                email = '', 
    ...
    def testGroupsMemberships200Response(self):
        """Test GroupsMemberships200Response"""
