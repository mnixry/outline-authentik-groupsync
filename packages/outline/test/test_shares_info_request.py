...
class TestSharesInfoRequest(unittest.TestCase):
    """SharesInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesInfoRequest:
        """Test SharesInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesInfoRequest`
        """
        model = SharesInfoRequest()
        if include_optional:
            return SharesInfoRequest(
                id = '',
                document_id = ''
            )
        else:
    ...
    def testSharesInfoRequest(self):
        """Test SharesInfoRequest"""
