...
class TestDocumentsMoveRequest(unittest.TestCase):
    """DocumentsMoveRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMoveRequest:
        """Test DocumentsMoveRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMoveRequest`
        """
        model = DocumentsMoveRequest()
        if include_optional:
            return DocumentsMoveRequest(
                id = 'hDYep1TPAM',
                collection_id = '',
                parent_document_id = ''
            )
    ...
    def testDocumentsMoveRequest(self):
        """Test DocumentsMoveRequest"""
