...
class TestGroupsMembershipsRequest(unittest.TestCase):
    """GroupsMembershipsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsMembershipsRequest:
        """Test GroupsMembershipsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsMembershipsRequest`
        """
        model = GroupsMembershipsRequest()
        if include_optional:
            return GroupsMembershipsRequest(
                offset = 0,
                limit = 25,
    ...
    def testGroupsMembershipsRequest(self):
        """Test GroupsMembershipsRequest"""
