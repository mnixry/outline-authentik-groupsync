...
class TestUsersUpdateRoleRequest(unittest.TestCase):
    """UsersUpdateRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersUpdateRoleRequest:
        """Test UsersUpdateRoleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersUpdateRoleRequest`
        """
        model = UsersUpdateRoleRequest()
        if include_optional:
            return UsersUpdateRoleRequest(
                id = '',
                role = 'admin'
            )
        else:
    ...
    def testUsersUpdateRoleRequest(self):
        """Test UsersUpdateRoleRequest"""
