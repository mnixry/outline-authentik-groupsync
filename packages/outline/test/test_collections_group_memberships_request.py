...
class TestCollectionsGroupMembershipsRequest(unittest.TestCase):
    """CollectionsGroupMembershipsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMembershipsRequest:
        """Test CollectionsGroupMembershipsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMembershipsRequest`
        """
        model = CollectionsGroupMembershipsRequest()
        if include_optional:
            return CollectionsGroupMembershipsRequest(
                offset = 0,
                limit = 25,
                id = '',
                query = 'developers',
    ...
    def testCollectionsGroupMembershipsRequest(self):
        """Test CollectionsGroupMembershipsRequest"""
