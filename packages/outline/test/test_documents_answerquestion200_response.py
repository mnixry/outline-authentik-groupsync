...
class TestDocumentsAnswerquestion200Response(unittest.TestCase):
    """DocumentsAnswerquestion200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsAnswerquestion200Response:
        """Test DocumentsAnswerquestion200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsAnswerquestion200Response`
        """
        model = DocumentsAnswerquestion200Response()
        if include_optional:
            return DocumentsAnswerquestion200Response(
                documents = [
                ...
                search = outline_openapi.models.search_result.SearchResult(
                    id = '', 
    ...
    def testDocumentsAnswerquestion200Response(self):
        """Test DocumentsAnswerquestion200Response"""
