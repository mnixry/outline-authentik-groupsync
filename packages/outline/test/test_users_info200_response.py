...
class TestUsersInfo200Response(unittest.TestCase):
    """UsersInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInfo200Response:
        """Test UsersInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInfo200Response`
        """
        model = UsersInfo200Response()
        if include_optional:
            return UsersInfo200Response(
                data = outline_openapi.models.user.User(
                    id = '', 
                    name = 'Jane Doe', 
                    avatar_url = '', 
                    email = '', 
    ...
    def testUsersInfo200Response(self):
        """Test UsersInfo200Response"""
