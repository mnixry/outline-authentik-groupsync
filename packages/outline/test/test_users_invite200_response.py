...
class TestUsersInvite200Response(unittest.TestCase):
    """UsersInvite200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInvite200Response:
        """Test UsersInvite200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInvite200Response`
        """
        model = UsersInvite200Response()
        if include_optional:
            return UsersInvite200Response(
                data = outline_openapi.models.users_invite_200_response_data.usersInvite_200_response_data(
                    sent = [
                        outline_openapi.models.invite.Invite(
                            name = '', 
                            email = '', 
                            role = 'admin', )
                        ], 
    ...
    def testUsersInvite200Response(self):
        """Test UsersInvite200Response"""
