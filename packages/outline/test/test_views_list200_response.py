...
class TestViewsList200Response(unittest.TestCase):
    """ViewsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewsList200Response:
        """Test ViewsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewsList200Response`
        """
        model = ViewsList200Response()
        if include_optional:
            return ViewsList200Response(
                data = [
                    outline_openapi.models.view.View(
                        id = '', 
                        document_id = '', 
    ...
    def testViewsList200Response(self):
        """Test ViewsList200Response"""
