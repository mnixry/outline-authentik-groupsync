...
class TestCollectionsAddGroupRequest(unittest.TestCase):
    """CollectionsAddGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddGroupRequest:
        """Test CollectionsAddGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddGroupRequest`
        """
        model = CollectionsAddGroupRequest()
        if include_optional:
            return CollectionsAddGroupRequest(
                id = '',
                group_id = '',
                permission = 'read'
            )
    ...
    def testCollectionsAddGroupRequest(self):
        """Test CollectionsAddGroupRequest"""
