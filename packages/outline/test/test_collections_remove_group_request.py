...
class TestCollectionsRemoveGroupRequest(unittest.TestCase):
    """CollectionsRemoveGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsRemoveGroupRequest:
        """Test CollectionsRemoveGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsRemoveGroupRequest`
        """
        model = CollectionsRemoveGroupRequest()
        if include_optional:
            return CollectionsRemoveGroupRequest(
                id = '',
                group_id = ''
            )
        else:
    ...
    def testCollectionsRemoveGroupRequest(self):
        """Test CollectionsRemoveGroupRequest"""
