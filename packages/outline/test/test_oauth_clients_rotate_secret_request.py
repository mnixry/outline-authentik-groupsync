...
class TestOauthClientsRotateSecretRequest(unittest.TestCase):
    """OauthClientsRotateSecretRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsRotateSecretRequest:
        """Test OauthClientsRotateSecretRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsRotateSecretRequest`
        """
        model = OauthClientsRotateSecretRequest()
        if include_optional:
            return OauthClientsRotateSecretRequest(
                id = ''
            )
        else:
            return OauthClientsRotateSecretRequest(
    ...
    def testOauthClientsRotateSecretRequest(self):
        """Test OauthClientsRotateSecretRequest"""
