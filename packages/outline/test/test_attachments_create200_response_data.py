...
class TestAttachmentsCreate200ResponseData(unittest.TestCase):
    """AttachmentsCreate200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsCreate200ResponseData:
        """Test AttachmentsCreate200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsCreate200ResponseData`
        """
        model = AttachmentsCreate200ResponseData()
        if include_optional:
            return AttachmentsCreate200ResponseData(
    ...
    def testAttachmentsCreate200ResponseData(self):
        """Test AttachmentsCreate200ResponseData"""
