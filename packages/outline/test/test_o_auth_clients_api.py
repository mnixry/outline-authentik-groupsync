...
from outline_openapi.api.o_auth_clients_api import OAuthClientsApi


class TestOAuthClientsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_oauth_clients_create(self) -> None:
        """Test case for oauth_clients_create

        Create an OAuth client
        """
        pass

    async def test_oauth_clients_delete(self) -> None:
        """Test case for oauth_clients_delete

        Delete an OAuth client
        """
        pass

    async def test_oauth_clients_info(self) -> None:
        """Test case for oauth_clients_info

        Retrieve an OAuth client
        """
        pass

    async def test_oauth_clients_list(self) -> None:
        """Test case for oauth_clients_list

        List accessible OAuth clients
        """
        pass

    async def test_oauth_clients_rotate_secret(self) -> None:
        """Test case for oauth_clients_rotate_secret

        Rotate the secret for an OAuth client
        """
        pass

    async def test_oauth_clients_update(self) -> None:
        """Test case for oauth_clients_update
