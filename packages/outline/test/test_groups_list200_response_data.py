...
class TestGroupsList200ResponseData(unittest.TestCase):
    """GroupsList200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsList200ResponseData:
        """Test GroupsList200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsList200ResponseData`
        """
        model = GroupsList200ResponseData()
        if include_optional:
            return GroupsList200ResponseData(
                groups = [
    ...
    def testGroupsList200ResponseData(self):
        """Test GroupsList200ResponseData"""
