...
class TestDocumentsUsersPostRequest(unittest.TestCase):
    """DocumentsUsersPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUsersPostRequest:
        """Test DocumentsUsersPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUsersPostRequest`
        """
        model = DocumentsUsersPostRequest()
        if include_optional:
            return DocumentsUsersPostRequest(
                id = 'hDYep1TPAM',
                query = ''
            )
        else:
    ...
    def testDocumentsUsersPostRequest(self):
        """Test DocumentsUsersPostRequest"""
