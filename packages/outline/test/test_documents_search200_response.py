...
class TestDocumentsSearch200Response(unittest.TestCase):
    """DocumentsSearch200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsSearch200Response:
        """Test DocumentsSearch200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsSearch200Response`
        """
        model = DocumentsSearch200Response()
        if include_optional:
            return DocumentsSearch200Response(
                data = [
                    outline_openapi.models.documents_search_200_response_data_inner.documentsSearch_200_response_data_inner(
    ...
    def testDocumentsSearch200Response(self):
        """Test DocumentsSearch200Response"""
