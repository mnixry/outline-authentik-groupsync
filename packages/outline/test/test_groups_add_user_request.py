...
class TestGroupsAddUserRequest(unittest.TestCase):
    """GroupsAddUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsAddUserRequest:
        """Test GroupsAddUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsAddUserRequest`
        """
        model = GroupsAddUserRequest()
        if include_optional:
            return GroupsAddUserRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testGroupsAddUserRequest(self):
        """Test GroupsAddUserRequest"""
