...
class TestFileoperationsInfoRequest(unittest.TestCase):
    """FileoperationsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileoperationsInfoRequest:
        """Test FileoperationsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileoperationsInfoRequest`
        """
        model = FileoperationsInfoRequest()
        if include_optional:
            return FileoperationsInfoRequest(
                id = ''
            )
        else:
            return FileoperationsInfoRequest(
    ...
    def testFileoperationsInfoRequest(self):
        """Test FileoperationsInfoRequest"""
