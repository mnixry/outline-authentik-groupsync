...
class TestDocumentsInfoRequest(unittest.TestCase):
    """DocumentsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsInfoRequest:
        """Test DocumentsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsInfoRequest`
        """
        model = DocumentsInfoRequest()
        if include_optional:
            return DocumentsInfoRequest(
                id = '',
                share_id = ''
            )
        else:
    ...
    def testDocumentsInfoRequest(self):
        """Test DocumentsInfoRequest"""
