...
class TestDocumentsRemoveUserRequest(unittest.TestCase):
    """DocumentsRemoveUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsRemoveUserRequest:
        """Test DocumentsRemoveUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsRemoveUserRequest`
        """
        model = DocumentsRemoveUserRequest()
        if include_optional:
            return DocumentsRemoveUserRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testDocumentsRemoveUserRequest(self):
        """Test DocumentsRemoveUserRequest"""
