...
class TestEventsListRequest(unittest.TestCase):
    """EventsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsListRequest:
        """Test EventsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsListRequest`
        """
        model = EventsListRequest()
        if include_optional:
    ...
    def testEventsListRequest(self):
        """Test EventsListRequest"""
