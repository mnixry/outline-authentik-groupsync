...
class TestDocumentsListRequest(unittest.TestCase):
    """DocumentsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsListRequest:
        """Test DocumentsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsListRequest`
        """
        model = DocumentsListRequest()
        if include_optional:
    ...
    def testDocumentsListRequest(self):
        """Test DocumentsListRequest"""
