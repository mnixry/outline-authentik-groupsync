...
class TestGroupsList200Response(unittest.TestCase):
    """GroupsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsList200Response:
        """Test GroupsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsList200Response`
        """
        model = GroupsList200Response()
        if include_optional:
            return GroupsList200Response(
                data = outline_openapi.models.groups_list_200_response_data.groupsList_200_response_data(
                    groups = [
    ...
    def testGroupsList200Response(self):
        """Test GroupsList200Response"""
