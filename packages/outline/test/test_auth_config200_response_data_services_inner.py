...
class TestAuthConfig200ResponseDataServicesInner(unittest.TestCase):
    """AuthConfig200ResponseDataServicesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfig200ResponseDataServicesInner:
        """Test AuthConfig200ResponseDataServicesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfig200ResponseDataServicesInner`
        """
        model = AuthConfig200ResponseDataServicesInner()
        if include_optional:
            return AuthConfig200ResponseDataServicesInner(
                id = 'slack',
                name = 'Slack',
    ...
    def testAuthConfig200ResponseDataServicesInner(self):
        """Test AuthConfig200ResponseDataServicesInner"""
