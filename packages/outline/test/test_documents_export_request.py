...
class TestDocumentsExportRequest(unittest.TestCase):
    """DocumentsExportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsExportRequest:
        """Test DocumentsExportRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsExportRequest`
        """
        model = DocumentsExportRequest()
        if include_optional:
            return DocumentsExportRequest(
                id = ''
            )
        else:
            return DocumentsExportRequest(
    ...
    def testDocumentsExportRequest(self):
        """Test DocumentsExportRequest"""
