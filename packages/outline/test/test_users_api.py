...
class TestUsersApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_users_activate_post(self) -> None:
    ...
    async def test_users_delete_post(self) -> None:
    ...
    async def test_users_info_post(self) -> None:
    ...
    async def test_users_invite_post(self) -> None:
    ...
    async def test_users_list_post(self) -> None:
    ...
    async def test_users_suspend_post(self) -> None:
    ...
    async def test_users_update_post(self) -> None:
    ...
    async def test_users_update_role_post(self) -> None:
