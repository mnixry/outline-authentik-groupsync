...
class TestOauthClientsUpdateRequest(unittest.TestCase):
    """OauthClientsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsUpdateRequest:
        """Test OauthClientsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsUpdateRequest`
        """
        model = OauthClientsUpdateRequest()
        if include_optional:
            return OauthClientsUpdateRequest(
                id = '',
                name = 'My App',
    ...
    def testOauthClientsUpdateRequest(self):
        """Test OauthClientsUpdateRequest"""
