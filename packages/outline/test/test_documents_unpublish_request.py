...
class TestDocumentsUnpublishRequest(unittest.TestCase):
    """DocumentsUnpublishRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUnpublishRequest:
        """Test DocumentsUnpublishRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUnpublishRequest`
        """
        model = DocumentsUnpublishRequest()
        if include_optional:
            return DocumentsUnpublishRequest(
                id = 'hDYep1TPAM'
            )
        else:
            return DocumentsUnpublishRequest(
    ...
    def testDocumentsUnpublishRequest(self):
        """Test DocumentsUnpublishRequest"""
