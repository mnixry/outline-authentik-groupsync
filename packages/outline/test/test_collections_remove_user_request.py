...
class TestCollectionsRemoveUserRequest(unittest.TestCase):
    """CollectionsRemoveUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsRemoveUserRequest:
        """Test CollectionsRemoveUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsRemoveUserRequest`
        """
        model = CollectionsRemoveUserRequest()
        if include_optional:
            return CollectionsRemoveUserRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testCollectionsRemoveUserRequest(self):
        """Test CollectionsRemoveUserRequest"""
