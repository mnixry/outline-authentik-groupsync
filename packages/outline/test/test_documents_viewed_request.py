...
class TestDocumentsViewedRequest(unittest.TestCase):
    """DocumentsViewedRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsViewedRequest:
        """Test DocumentsViewedRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsViewedRequest`
        """
        model = DocumentsViewedRequest()
        if include_optional:
            return DocumentsViewedRequest(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC'
    ...
    def testDocumentsViewedRequest(self):
        """Test DocumentsViewedRequest"""
