...
class TestEventsList200Response(unittest.TestCase):
    """EventsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventsList200Response:
        """Test EventsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventsList200Response`
        """
        model = EventsList200Response()
        if include_optional:
            return EventsList200Response(
                data = [
                    outline_openapi.models.event.Event(
                        id = '', 
                        ...
                        actor = outline_openapi.models.user.User(
                            id = '', 
                            name = 'Jane Doe', 
                            avatar_url = '', 
                            email = '', 
    ...
    def testEventsList200Response(self):
        """Test EventsList200Response"""
