...
class TestFileoperationsListRequest(unittest.TestCase):
    """FileoperationsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileoperationsListRequest:
        """Test FileoperationsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileoperationsListRequest`
        """
        model = FileoperationsListRequest()
        if include_optional:
            return FileoperationsListRequest(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testFileoperationsListRequest(self):
        """Test FileoperationsListRequest"""
