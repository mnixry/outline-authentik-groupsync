...
class TestGroupsRemoveUser200ResponseData(unittest.TestCase):
    """GroupsRemoveUser200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsRemoveUser200ResponseData:
        """Test GroupsRemoveUser200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsRemoveUser200ResponseData`
        """
        model = GroupsRemoveUser200ResponseData()
        if include_optional:
            return GroupsRemoveUser200ResponseData(
                groups = [
    ...
    def testGroupsRemoveUser200ResponseData(self):
        """Test GroupsRemoveUser200ResponseData"""
