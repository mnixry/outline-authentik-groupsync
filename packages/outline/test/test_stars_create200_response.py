...
class TestStarsCreate200Response(unittest.TestCase):
    """StarsCreate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarsCreate200Response:
        """Test StarsCreate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarsCreate200Response`
        """
        model = StarsCreate200Response()
        if include_optional:
            return StarsCreate200Response(
                data = outline_openapi.models.star.Star(
                    id = '', 
                    index = '', 
                    document_id = '', 
                    collection_id = '', 
    ...
    def testStarsCreate200Response(self):
        """Test StarsCreate200Response"""
