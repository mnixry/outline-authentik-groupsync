...
class TestCollectionsExportRequest(unittest.TestCase):
    """CollectionsExportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportRequest:
        """Test CollectionsExportRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportRequest`
        """
        model = CollectionsExportRequest()
        if include_optional:
            return CollectionsExportRequest(
    ...
    def testCollectionsExportRequest(self):
        """Test CollectionsExportRequest"""
