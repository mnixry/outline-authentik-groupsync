...
class TestRevisionsInfoRequest(unittest.TestCase):
    """RevisionsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsInfoRequest:
        """Test RevisionsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsInfoRequest`
        """
        model = RevisionsInfoRequest()
        if include_optional:
            return RevisionsInfoRequest(
                id = ''
            )
        else:
            return RevisionsInfoRequest(
    ...
    def testRevisionsInfoRequest(self):
        """Test RevisionsInfoRequest"""
