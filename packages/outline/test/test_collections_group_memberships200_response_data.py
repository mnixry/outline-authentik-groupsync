...
class TestCollectionsGroupMemberships200ResponseData(unittest.TestCase):
    """CollectionsGroupMemberships200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMemberships200ResponseData:
        """Test CollectionsGroupMemberships200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMemberships200ResponseData`
        """
        model = CollectionsGroupMemberships200ResponseData()
        if include_optional:
            return CollectionsGroupMemberships200ResponseData(
                groups = [
    ...
    def testCollectionsGroupMemberships200ResponseData(self):
        """Test CollectionsGroupMemberships200ResponseData"""
