...
class TestCommentsInfo200Response(unittest.TestCase):
    """CommentsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsInfo200Response:
        """Test CommentsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsInfo200Response`
        """
        model = CommentsInfo200Response()
        if include_optional:
            return CommentsInfo200Response(
    ...
    def testCommentsInfo200Response(self):
        """Test CommentsInfo200Response"""
