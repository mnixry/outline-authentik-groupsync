...
class TestCommentsListRequest(unittest.TestCase):
    """CommentsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsListRequest:
        """Test CommentsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsListRequest`
        """
        model = CommentsListRequest()
        if include_optional:
    ...
    def testCommentsListRequest(self):
        """Test CommentsListRequest"""
