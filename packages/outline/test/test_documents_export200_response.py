...
class TestDocumentsExport200Response(unittest.TestCase):
    """DocumentsExport200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsExport200Response:
        """Test DocumentsExport200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsExport200Response`
        """
        model = DocumentsExport200Response()
        if include_optional:
            return DocumentsExport200Response(
                data = ''
            )
        else:
            return DocumentsExport200Response(
    ...
    def testDocumentsExport200Response(self):
        """Test DocumentsExport200Response"""
