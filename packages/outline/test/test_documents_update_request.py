...
class TestDocumentsUpdateRequest(unittest.TestCase):
    """DocumentsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUpdateRequest:
        """Test DocumentsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUpdateRequest`
        """
        model = DocumentsUpdateRequest()
        if include_optional:
    ...
    def testDocumentsUpdateRequest(self):
        """Test DocumentsUpdateRequest"""
