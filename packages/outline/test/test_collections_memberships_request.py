...
class TestCollectionsMembershipsRequest(unittest.TestCase):
    """CollectionsMembershipsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsMembershipsRequest:
        """Test CollectionsMembershipsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsMembershipsRequest`
        """
        model = CollectionsMembershipsRequest()
        if include_optional:
            return CollectionsMembershipsRequest(
                offset = 0,
                limit = 25,
                id = '',
                query = 'jenny',
    ...
    def testCollectionsMembershipsRequest(self):
        """Test CollectionsMembershipsRequest"""
