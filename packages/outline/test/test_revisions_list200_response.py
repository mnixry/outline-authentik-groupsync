...
class TestRevisionsList200Response(unittest.TestCase):
    """RevisionsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsList200Response:
        """Test RevisionsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsList200Response`
        """
        model = RevisionsList200Response()
        if include_optional:
            return RevisionsList200Response(
                data = [
                    outline_openapi.models.revision.Revision(
                        id = '', 
                        document_id = '', 
                        title = '', 
                        text = '', 
    ...
    def testRevisionsList200Response(self):
        """Test RevisionsList200Response"""
