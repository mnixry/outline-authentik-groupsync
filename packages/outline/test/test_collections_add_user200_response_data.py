...
class TestCollectionsAddUser200ResponseData(unittest.TestCase):
    """CollectionsAddUser200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddUser200ResponseData:
        """Test CollectionsAddUser200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddUser200ResponseData`
        """
        model = CollectionsAddUser200ResponseData()
        if include_optional:
            return CollectionsAddUser200ResponseData(
                users = [
    ...
    def testCollectionsAddUser200ResponseData(self):
        """Test CollectionsAddUser200ResponseData"""
