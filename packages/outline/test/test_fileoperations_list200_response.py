...
class TestFileoperationsList200Response(unittest.TestCase):
    """FileoperationsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileoperationsList200Response:
        """Test FileoperationsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileoperationsList200Response`
        """
        model = FileoperationsList200Response()
        if include_optional:
            return FileoperationsList200Response(
                data = [
                    outline_openapi.models.file_operation.FileOperation(
                        id = '', 
                        type = 'export', 
                        state = 'complete', 
                        collection = null, 
    ...
    def testFileoperationsList200Response(self):
        """Test FileoperationsList200Response"""
