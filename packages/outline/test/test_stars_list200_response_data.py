...
class TestStarsList200ResponseData(unittest.TestCase):
    """StarsList200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarsList200ResponseData:
        """Test StarsList200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarsList200ResponseData`
        """
        model = StarsList200ResponseData()
        if include_optional:
            return StarsList200ResponseData(
                stars = [
    ...
    def testStarsList200ResponseData(self):
        """Test StarsList200ResponseData"""
