...
class TestCollectionsAddGroup200Response(unittest.TestCase):
    """CollectionsAddGroup200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddGroup200Response:
        """Test CollectionsAddGroup200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddGroup200Response`
        """
        model = CollectionsAddGroup200Response()
        if include_optional:
            return CollectionsAddGroup200Response(
                data = outline_openapi.models.collections_add_group_200_response_data.collectionsAddGroup_200_response_data(
    ...
    def testCollectionsAddGroup200Response(self):
        """Test CollectionsAddGroup200Response"""
