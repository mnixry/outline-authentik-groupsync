...
class TestCollectionsDeleteRequest(unittest.TestCase):
    """CollectionsDeleteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsDeleteRequest:
        """Test CollectionsDeleteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsDeleteRequest`
        """
        model = CollectionsDeleteRequest()
        if include_optional:
    ...
    def testCollectionsDeleteRequest(self):
        """Test CollectionsDeleteRequest"""
