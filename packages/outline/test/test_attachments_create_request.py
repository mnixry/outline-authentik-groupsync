...
class TestAttachmentsCreateRequest(unittest.TestCase):
    """AttachmentsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsCreateRequest:
        """Test AttachmentsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsCreateRequest`
        """
        model = AttachmentsCreateRequest()
        if include_optional:
    ...
    def testAttachmentsCreateRequest(self):
        """Test AttachmentsCreateRequest"""
