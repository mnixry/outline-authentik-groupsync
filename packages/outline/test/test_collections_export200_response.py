...
class TestCollectionsExport200Response(unittest.TestCase):
    """CollectionsExport200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExport200Response:
        """Test CollectionsExport200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExport200Response`
        """
        model = CollectionsExport200Response()
        if include_optional:
            return CollectionsExport200Response(
                data = outline_openapi.models.collections_export_200_response_data.collectionsExport_200_response_data(
                    file_operation = outline_openapi.models.file_operation.FileOperation(
                        id = '', 
                        type = 'export', 
                        state = 'complete', 
                        collection = null, 
    ...
    def testCollectionsExport200Response(self):
        """Test CollectionsExport200Response"""
