...
class TestAuthConfig200ResponseData(unittest.TestCase):
    """AuthConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfig200ResponseData:
        """Test AuthConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfig200ResponseData`
        """
        model = AuthConfig200ResponseData()
        if include_optional:
            return AuthConfig200ResponseData(
                name = 'Acme Inc',
    ...
    def testAuthConfig200ResponseData(self):
        """Test AuthConfig200ResponseData"""
