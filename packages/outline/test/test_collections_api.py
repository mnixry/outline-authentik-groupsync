...
class TestCollectionsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_collections_add_group_post(self) -> None:
    ...
    async def test_collections_add_user_post(self) -> None:
    ...
    async def test_collections_create_post(self) -> None:
    ...
    async def test_collections_delete_post(self) -> None:
    ...
    async def test_collections_documents_post(self) -> None:
    ...
    async def test_collections_export_all_post(self) -> None:
    ...
    async def test_collections_export_post(self) -> None:
    ...
    async def test_collections_group_memberships_post(self) -> None:
    ...
    async def test_collections_info_post(self) -> None:
    ...
    async def test_collections_list_post(self) -> None:
    ...
    async def test_collections_memberships_post(self) -> None:
    ...
    async def test_collections_remove_group_post(self) -> None:
    ...
    async def test_collections_remove_user_post(self) -> None:
    ...
    async def test_collections_update_post(self) -> None:
