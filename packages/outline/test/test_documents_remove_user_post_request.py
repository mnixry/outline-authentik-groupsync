...
class TestDocumentsRemoveUserPostRequest(unittest.TestCase):
    """DocumentsRemoveUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsRemoveUserPostRequest:
        """Test DocumentsRemoveUserPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsRemoveUserPostRequest`
        """
        model = DocumentsRemoveUserPostRequest()
        if include_optional:
            return DocumentsRemoveUserPostRequest(
                id = '',
                user_id = ''
            )
        else:
    ...
    def testDocumentsRemoveUserPostRequest(self):
        """Test DocumentsRemoveUserPostRequest"""
