...
class TestCollectionsDocuments200Response(unittest.TestCase):
    """CollectionsDocuments200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsDocuments200Response:
        """Test CollectionsDocuments200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsDocuments200Response`
        """
        model = CollectionsDocuments200Response()
        if include_optional:
            return CollectionsDocuments200Response(
                data = []
            )
        else:
            return CollectionsDocuments200Response(
    ...
    def testCollectionsDocuments200Response(self):
        """Test CollectionsDocuments200Response"""
