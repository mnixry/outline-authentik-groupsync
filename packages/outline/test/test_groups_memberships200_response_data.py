...
class TestGroupsMemberships200ResponseData(unittest.TestCase):
    """GroupsMemberships200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsMemberships200ResponseData:
        """Test GroupsMemberships200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsMemberships200ResponseData`
        """
        model = GroupsMemberships200ResponseData()
        if include_optional:
            return GroupsMemberships200ResponseData(
                users = [
    ...
    def testGroupsMemberships200ResponseData(self):
        """Test GroupsMemberships200ResponseData"""
