...
class TestDocumentsDraftsRequest(unittest.TestCase):
    """DocumentsDraftsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsDraftsRequest:
        """Test DocumentsDraftsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsDraftsRequest`
        """
        model = DocumentsDraftsRequest()
        if include_optional:
            return DocumentsDraftsRequest(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testDocumentsDraftsRequest(self):
        """Test DocumentsDraftsRequest"""
