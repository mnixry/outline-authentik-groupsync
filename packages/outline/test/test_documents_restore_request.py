...
class TestDocumentsRestoreRequest(unittest.TestCase):
    """DocumentsRestoreRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsRestoreRequest:
        """Test DocumentsRestoreRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsRestoreRequest`
        """
        model = DocumentsRestoreRequest()
        if include_optional:
            return DocumentsRestoreRequest(
                id = 'hDYep1TPAM',
                revision_id = ''
            )
        else:
    ...
    def testDocumentsRestoreRequest(self):
        """Test DocumentsRestoreRequest"""
