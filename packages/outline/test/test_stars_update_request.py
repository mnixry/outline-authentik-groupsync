...
class TestStarsUpdateRequest(unittest.TestCase):
    """StarsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarsUpdateRequest:
        """Test StarsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarsUpdateRequest`
        """
        model = StarsUpdateRequest()
        if include_optional:
            return StarsUpdateRequest(
                id = '',
                index = ''
            )
        else:
    ...
    def testStarsUpdateRequest(self):
        """Test StarsUpdateRequest"""
