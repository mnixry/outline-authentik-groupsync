...
class TestCommentsUpdateRequest(unittest.TestCase):
    """CommentsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsUpdateRequest:
        """Test CommentsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsUpdateRequest`
        """
        model = CommentsUpdateRequest()
        if include_optional:
    ...
    def testCommentsUpdateRequest(self):
        """Test CommentsUpdateRequest"""
