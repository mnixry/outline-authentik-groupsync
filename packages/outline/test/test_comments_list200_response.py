...
class TestCommentsList200Response(unittest.TestCase):
    """CommentsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsList200Response:
        """Test CommentsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsList200Response`
        """
        model = CommentsList200Response()
        if include_optional:
            return CommentsList200Response(
                data = [
                    outline_openapi.models.comment.Comment(
                        id = '', 
                        data = outline_openapi.models.data.data(), 
                        document_id = '', 
                        parent_comment_id = '', 
                        ...
                        updated_by = outline_openapi.models.user.User(
                            id = '', 
                            name = 'Jane Doe', 
                            avatar_url = '', 
                            email = '', 
    ...
    def testCommentsList200Response(self):
        """Test CommentsList200Response"""
