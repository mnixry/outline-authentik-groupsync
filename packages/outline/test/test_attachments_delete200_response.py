...
class TestAttachmentsDelete200Response(unittest.TestCase):
    """AttachmentsDelete200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsDelete200Response:
        """Test AttachmentsDelete200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsDelete200Response`
        """
        model = AttachmentsDelete200Response()
        if include_optional:
            return AttachmentsDelete200Response(
                success = True
            )
        else:
            return AttachmentsDelete200Response(
    ...
    def testAttachmentsDelete200Response(self):
        """Test AttachmentsDelete200Response"""
