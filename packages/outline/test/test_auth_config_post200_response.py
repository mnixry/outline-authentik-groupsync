    ...
    def make_instance(self, include_optional) -> AuthConfigPost200Response:
        ...
        if include_optional:
            return AuthConfigPost200Response(
                data = outline_openapi.models._auth_config_post_200_response_data._auth_config_post_200_response_data(
                    name = 'Acme Inc', 
                    hostname = 'acme-inc.getoutline.com', 
                    services = [
                        outline_openapi.models._auth_config_post_200_response_data_services_inner._auth_config_post_200_response_data_services_inner(
                            id = 'slack', 
                            name = 'Slack', 
