...
class TestDocumentsSearch200ResponseDataInner(unittest.TestCase):
    """DocumentsSearch200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsSearch200ResponseDataInner:
        """Test DocumentsSearch200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsSearch200ResponseDataInner`
        """
        model = DocumentsSearch200ResponseDataInner()
        if include_optional:
            return DocumentsSearch200ResponseDataInner(
    ...
    def testDocumentsSearch200ResponseDataInner(self):
        """Test DocumentsSearch200ResponseDataInner"""
