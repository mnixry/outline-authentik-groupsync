...
class TestRevisionsListRequest(unittest.TestCase):
    """RevisionsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsListRequest:
        """Test RevisionsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsListRequest`
        """
        model = RevisionsListRequest()
        if include_optional:
            return RevisionsListRequest(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testRevisionsListRequest(self):
        """Test RevisionsListRequest"""
