...
class TestDocumentsDeleteRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentsDeleteRequest:
        """Test DocumentsDeleteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsDeleteRequest`
        """
        model = DocumentsDeleteRequest()
        if include_optional:
    ...
    def testDocumentsDeleteRequest(self):
        """Test DocumentsDeleteRequest"""
