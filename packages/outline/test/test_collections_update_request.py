...
class TestCollectionsUpdateRequest(unittest.TestCase):
    """CollectionsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsUpdateRequest:
        """Test CollectionsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsUpdateRequest`
        """
        model = CollectionsUpdateRequest()
        if include_optional:
            return CollectionsUpdateRequest(
                id = '',
    ...
    def testCollectionsUpdateRequest(self):
        """Test CollectionsUpdateRequest"""
