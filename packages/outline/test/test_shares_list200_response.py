...
class TestSharesList200Response(unittest.TestCase):
    """SharesList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesList200Response:
        """Test SharesList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesList200Response`
        """
        model = SharesList200Response()
        if include_optional:
            return SharesList200Response(
                data = [
                    outline_openapi.models.share.Share(
                        id = '', 
    ...
    def testSharesList200Response(self):
        """Test SharesList200Response"""
