...
class TestViewsListRequest(unittest.TestCase):
    """ViewsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewsListRequest:
        """Test ViewsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewsListRequest`
        """
        model = ViewsListRequest()
        if include_optional:
            return ViewsListRequest(
                document_id = ''
            )
        else:
            return ViewsListRequest(
