...
class TestCommentsInfoRequest(unittest.TestCase):
    """CommentsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsInfoRequest:
        """Test CommentsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsInfoRequest`
        """
        model = CommentsInfoRequest()
        if include_optional:
            return CommentsInfoRequest(
                id = '',
    ...
    def testCommentsInfoRequest(self):
        """Test CommentsInfoRequest"""
