...
class TestAuthConfig200Response(unittest.TestCase):
    """AuthConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfig200Response:
        """Test AuthConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfig200Response`
        """
        model = AuthConfig200Response()
        if include_optional:
            return AuthConfig200Response(
                data = outline_openapi.models.auth_config_200_response_data.authConfig_200_response_data(
                    name = 'Acme Inc', 
                    hostname = 'acme-inc.getoutline.com', 
                    services = [
                        outline_openapi.models.auth_config_200_response_data_services_inner.authConfig_200_response_data_services_inner(
                            id = 'slack', 
                            name = 'Slack', 
    ...
    def testAuthConfig200Response(self):
        """Test AuthConfig200Response"""
