...
class TestDocumentsMembershipsPostRequest(unittest.TestCase):
    """DocumentsMembershipsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMembershipsPostRequest:
        """Test DocumentsMembershipsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMembershipsPostRequest`
        """
        model = DocumentsMembershipsPostRequest()
        if include_optional:
            return DocumentsMembershipsPostRequest(
                id = 'hDYep1TPAM',
                query = ''
            )
        else:
    ...
    def testDocumentsMembershipsPostRequest(self):
        """Test DocumentsMembershipsPostRequest"""
