...
class TestUsersListRequest(unittest.TestCase):
    """UsersListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersListRequest:
        """Test UsersListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersListRequest`
        """
        ...
        if include_optional:
            return UsersListRequest(
                ...
                direction = 'DESC',
                query = 'jane',
                emails = ["jane.crandall@mail.com","prudence.crandall@mail.com"],
                filter = 'all',
                role = 'admin'
            )
        else:
