...
class TestGroupsUpdateRequest(unittest.TestCase):
    """GroupsUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsUpdateRequest:
        """Test GroupsUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsUpdateRequest`
        """
        model = GroupsUpdateRequest()
        if include_optional:
            return GroupsUpdateRequest(
                id = '',
                name = 'Designers'
            )
        else:
    ...
    def testGroupsUpdateRequest(self):
        """Test GroupsUpdateRequest"""
