...
class TestCollectionsListRequest(unittest.TestCase):
    """CollectionsListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsListRequest:
        """Test CollectionsListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsListRequest`
        """
        model = CollectionsListRequest()
        if include_optional:
    ...
    def testCollectionsListRequest(self):
        """Test CollectionsListRequest"""
