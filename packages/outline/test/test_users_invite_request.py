...
class TestUsersInviteRequest(unittest.TestCase):
    """UsersInviteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInviteRequest:
        """Test UsersInviteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInviteRequest`
        """
        model = UsersInviteRequest()
        if include_optional:
            return UsersInviteRequest(
                invites = [
    ...
    def testUsersInviteRequest(self):
        """Test UsersInviteRequest"""
