...
class TestCollectionsInfoRequest(unittest.TestCase):
    """CollectionsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsInfoRequest:
        """Test CollectionsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsInfoRequest`
        """
        model = CollectionsInfoRequest()
        if include_optional:
            return CollectionsInfoRequest(
                id = ''
            )
        else:
            return CollectionsInfoRequest(
    ...
    def testCollectionsInfoRequest(self):
        """Test CollectionsInfoRequest"""
