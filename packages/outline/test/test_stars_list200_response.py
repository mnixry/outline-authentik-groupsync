...
class TestStarsList200Response(unittest.TestCase):
    """StarsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarsList200Response:
        """Test StarsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarsList200Response`
        """
        model = StarsList200Response()
        if include_optional:
            return StarsList200Response(
                data = outline_openapi.models.stars_list_200_response_data.starsList_200_response_data(
                    stars = [
                        outline_openapi.models.star.Star(
                            id = '', 
                            index = '', 
                            document_id = '', 
                            collection_id = '', 
    ...
    def testStarsList200Response(self):
        """Test StarsList200Response"""
