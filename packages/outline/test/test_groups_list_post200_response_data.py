...
class TestGroupsListPost200ResponseData(unittest.TestCase):
    """GroupsListPost200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsListPost200ResponseData:
        """Test GroupsListPost200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsListPost200ResponseData`
        """
        model = GroupsListPost200ResponseData()
        if include_optional:
            return GroupsListPost200ResponseData(
                groups = [
    ...
    def testGroupsListPost200ResponseData(self):
        """Test GroupsListPost200ResponseData"""
