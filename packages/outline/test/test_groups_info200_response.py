...
class TestGroupsInfo200Response(unittest.TestCase):
    """GroupsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsInfo200Response:
        """Test GroupsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsInfo200Response`
        """
        model = GroupsInfo200Response()
        if include_optional:
            return GroupsInfo200Response(
                data = outline_openapi.models.group.Group(
                    id = '', 
                    name = 'Engineering', 
                    member_count = 11, 
    ...
    def testGroupsInfo200Response(self):
        """Test GroupsInfo200Response"""
