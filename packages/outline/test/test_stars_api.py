...
from outline_openapi.api.stars_api import StarsApi


class TestStarsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_stars_create(self) -> None:
        """Test case for stars_create

        Create a star
        """
        pass

    async def test_stars_delete(self) -> None:
        """Test case for stars_delete

        Delete a star
        """
        pass

    async def test_stars_list(self) -> None:
    ...
    async def test_stars_update(self) -> None:
        """Test case for stars_update
