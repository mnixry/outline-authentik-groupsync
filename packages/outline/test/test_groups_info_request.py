...
class TestGroupsInfoRequest(unittest.TestCase):
    """GroupsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsInfoRequest:
        """Test GroupsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsInfoRequest`
        """
        model = GroupsInfoRequest()
        if include_optional:
    ...
    def testGroupsInfoRequest(self):
        """Test GroupsInfoRequest"""
