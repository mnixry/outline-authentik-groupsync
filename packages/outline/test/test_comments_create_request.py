...
class TestCommentsCreateRequest(unittest.TestCase):
    """CommentsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentsCreateRequest:
        """Test CommentsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentsCreateRequest`
        """
        model = CommentsCreateRequest()
        if include_optional:
    ...
    def testCommentsCreateRequest(self):
        """Test CommentsCreateRequest"""
