...
class TestDocumentsAnswerquestionRequest(unittest.TestCase):
    """DocumentsAnswerquestionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsAnswerquestionRequest:
        """Test DocumentsAnswerquestionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsAnswerquestionRequest`
        """
        model = DocumentsAnswerquestionRequest()
        if include_optional:
            return DocumentsAnswerquestionRequest(
    ...
    def testDocumentsAnswerquestionRequest(self):
        """Test DocumentsAnswerquestionRequest"""
