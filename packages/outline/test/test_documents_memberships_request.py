...
class TestDocumentsMembershipsRequest(unittest.TestCase):
    """DocumentsMembershipsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsMembershipsRequest:
        """Test DocumentsMembershipsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsMembershipsRequest`
        """
        model = DocumentsMembershipsRequest()
        if include_optional:
            return DocumentsMembershipsRequest(
                id = 'hDYep1TPAM',
                query = ''
            )
        else:
    ...
    def testDocumentsMembershipsRequest(self):
        """Test DocumentsMembershipsRequest"""
