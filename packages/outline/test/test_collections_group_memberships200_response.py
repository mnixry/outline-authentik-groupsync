...
class TestCollectionsGroupMemberships200Response(unittest.TestCase):
    """CollectionsGroupMemberships200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsGroupMemberships200Response:
        """Test CollectionsGroupMemberships200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsGroupMemberships200Response`
        """
        model = CollectionsGroupMemberships200Response()
        if include_optional:
            return CollectionsGroupMemberships200Response(
                data = outline_openapi.models.collections_group_memberships_200_response_data.collectionsGroupMemberships_200_response_data(
                    groups = [
                    ...
                    collection_group_memberships = [
                        outline_openapi.models.collection_group_membership.CollectionGroupMembership(
                            id = '', 
                            group_id = '', 
                            collection_id = '', 
                            permission = 'read', )
                        ], ),
                pagination = outline_openapi.models.pagination.Pagination(
                    offset = 0, 
                    limit = 25, )
            )
        else:
    ...
    def testCollectionsGroupMemberships200Response(self):
        """Test CollectionsGroupMemberships200Response"""
