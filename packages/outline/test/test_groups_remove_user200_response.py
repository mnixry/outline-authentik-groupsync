...
class TestGroupsRemoveUser200Response(unittest.TestCase):
    """GroupsRemoveUser200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsRemoveUser200Response:
        """Test GroupsRemoveUser200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsRemoveUser200Response`
        """
        model = GroupsRemoveUser200Response()
        if include_optional:
            return GroupsRemoveUser200Response(
                data = outline_openapi.models.groups_remove_user_200_response_data.groupsRemoveUser_200_response_data(
                    groups = [
    ...
    def testGroupsRemoveUser200Response(self):
        """Test GroupsRemoveUser200Response"""
