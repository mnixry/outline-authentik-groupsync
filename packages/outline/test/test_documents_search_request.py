...
class TestDocumentsSearchRequest(unittest.TestCase):
    """DocumentsSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsSearchRequest:
        """Test DocumentsSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsSearchRequest`
        """
        model = DocumentsSearchRequest()
        if include_optional:
            return DocumentsSearchRequest(
                offset = 0,
                limit = 25,
                query = 'hiring',
                user_id = '',
    ...
    def testDocumentsSearchRequest(self):
        """Test DocumentsSearchRequest"""
