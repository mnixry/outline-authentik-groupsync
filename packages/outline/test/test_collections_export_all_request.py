...
class TestCollectionsExportAllRequest(unittest.TestCase):
    """CollectionsExportAllRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsExportAllRequest:
        """Test CollectionsExportAllRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsExportAllRequest`
        """
        model = CollectionsExportAllRequest()
        if include_optional:
            return CollectionsExportAllRequest(
    ...
    def testCollectionsExportAllRequest(self):
        """Test CollectionsExportAllRequest"""
