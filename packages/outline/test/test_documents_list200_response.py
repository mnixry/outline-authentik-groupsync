...
class TestDocumentsList200Response(unittest.TestCase):
    """DocumentsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsList200Response:
        """Test DocumentsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsList200Response`
        """
        model = DocumentsList200Response()
        if include_optional:
    ...
    def testDocumentsList200Response(self):
        """Test DocumentsList200Response"""
