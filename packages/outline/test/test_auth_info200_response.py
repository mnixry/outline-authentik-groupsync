...
class TestAuthInfo200Response(unittest.TestCase):
    """AuthInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthInfo200Response:
        """Test AuthInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthInfo200Response`
        """
        model = AuthInfo200Response()
        if include_optional:
            return AuthInfo200Response(
                data = outline_openapi.models.auth.Auth(
                    ...
                    team = outline_openapi.models.team.Team(
                        id = '', 
                        name = '', 
                        avatar_url = '', 
                        sharing = True, 
    ...
    def testAuthInfo200Response(self):
        """Test AuthInfo200Response"""
