...
class TestAttachmentsRedirectRequest(unittest.TestCase):
    """AttachmentsRedirectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsRedirectRequest:
        """Test AttachmentsRedirectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsRedirectRequest`
        """
        model = AttachmentsRedirectRequest()
        if include_optional:
            return AttachmentsRedirectRequest(
                id = ''
            )
        else:
            return AttachmentsRedirectRequest(
    ...
    def testAttachmentsRedirectRequest(self):
        """Test AttachmentsRedirectRequest"""
