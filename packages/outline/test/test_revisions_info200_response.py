...
class TestRevisionsInfo200Response(unittest.TestCase):
    """RevisionsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevisionsInfo200Response:
        """Test RevisionsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevisionsInfo200Response`
        """
        model = RevisionsInfo200Response()
        if include_optional:
            return RevisionsInfo200Response(
                data = outline_openapi.models.revision.Revision(
                    id = '', 
                    document_id = '', 
                    title = '', 
                    text = '', 
    ...
    def testRevisionsInfo200Response(self):
        """Test RevisionsInfo200Response"""
