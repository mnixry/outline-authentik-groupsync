...
class TestStarsCreateRequest(unittest.TestCase):
    """StarsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StarsCreateRequest:
        """Test StarsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StarsCreateRequest`
        """
        model = StarsCreateRequest()
        if include_optional:
            return StarsCreateRequest(
                document_id = '',
                collection_id = '',
                index = ''
            )
    ...
    def testStarsCreateRequest(self):
        """Test StarsCreateRequest"""
