...
class TestFileOperationsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_file_operations_delete_post(self) -> None:
    ...
    async def test_file_operations_info_post(self) -> None:
    ...
    async def test_file_operations_list_post(self) -> None:
    ...
    async def test_file_operations_redirect_post(self) -> None:
