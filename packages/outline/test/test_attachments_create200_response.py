...
class TestAttachmentsCreate200Response(unittest.TestCase):
    """AttachmentsCreate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachmentsCreate200Response:
        """Test AttachmentsCreate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachmentsCreate200Response`
        """
        model = AttachmentsCreate200Response()
        if include_optional:
            return AttachmentsCreate200Response(
                data = outline_openapi.models.attachments_create_200_response_data.attachmentsCreate_200_response_data(
                    max_upload_size = 1.337, 
                    upload_url = '', 
                    form = outline_openapi.models.form.form(), 
                    attachment = outline_openapi.models.attachment.Attachment(
    ...
    def testAttachmentsCreate200Response(self):
        """Test AttachmentsCreate200Response"""
