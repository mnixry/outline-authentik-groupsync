...
class TestOauthClientsList200Response(unittest.TestCase):
    """OauthClientsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsList200Response:
        """Test OauthClientsList200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsList200Response`
        """
        model = OauthClientsList200Response()
        if include_optional:
            return OauthClientsList200Response(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
                data = [
                    outline_openapi.models.o_auth_client.OAuthClient(
                        id = '', 
                        name = 'Acme Inc', 
                        description = 'Integrate Acme Inc's services into Outline.', 
                        developer_name = 'Acme Inc', 
                        developer_url = 'https://example.com', 
                        avatar_url = '', 
                        client_id = '2bquf8avrpdv31par42a', 
                        client_secret = 'ol_sk_rapdv31...', 
    ...
    def testOauthClientsList200Response(self):
        """Test OauthClientsList200Response"""
