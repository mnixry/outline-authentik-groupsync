...
class TestCollectionsAddGroup200ResponseData(unittest.TestCase):
    """CollectionsAddGroup200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddGroup200ResponseData:
        """Test CollectionsAddGroup200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddGroup200ResponseData`
        """
        model = CollectionsAddGroup200ResponseData()
        if include_optional:
            return CollectionsAddGroup200ResponseData(
    ...
    def testCollectionsAddGroup200ResponseData(self):
        """Test CollectionsAddGroup200ResponseData"""
