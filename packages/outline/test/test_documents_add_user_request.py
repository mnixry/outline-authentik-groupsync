...
class TestDocumentsAddUserRequest(unittest.TestCase):
    """DocumentsAddUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsAddUserRequest:
        """Test DocumentsAddUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsAddUserRequest`
        """
        model = DocumentsAddUserRequest()
        if include_optional:
            return DocumentsAddUserRequest(
                id = '',
                user_id = '',
                permission = 'read'
            )
    ...
    def testDocumentsAddUserRequest(self):
        """Test DocumentsAddUserRequest"""
