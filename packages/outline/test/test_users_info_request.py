...
class TestUsersInfoRequest(unittest.TestCase):
    """UsersInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInfoRequest:
        """Test UsersInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInfoRequest`
        """
        model = UsersInfoRequest()
        if include_optional:
