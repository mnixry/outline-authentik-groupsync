...
class TestCollectionsAddUserRequest(unittest.TestCase):
    """CollectionsAddUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsAddUserRequest:
        """Test CollectionsAddUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsAddUserRequest`
        """
        model = CollectionsAddUserRequest()
        if include_optional:
            return CollectionsAddUserRequest(
                id = '',
                user_id = '',
                permission = 'read'
            )
    ...
    def testCollectionsAddUserRequest(self):
        """Test CollectionsAddUserRequest"""
