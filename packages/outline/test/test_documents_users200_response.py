...
class TestDocumentsUsers200Response(unittest.TestCase):
    """DocumentsUsers200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsUsers200Response:
        """Test DocumentsUsers200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsUsers200Response`
        """
        model = DocumentsUsers200Response()
        if include_optional:
            return DocumentsUsers200Response(
                data = [
    ...
    def testDocumentsUsers200Response(self):
        """Test DocumentsUsers200Response"""
