...
class TestOauthClientsCreateRequest(unittest.TestCase):
    """OauthClientsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsCreateRequest:
        """Test OauthClientsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsCreateRequest`
        """
        model = OauthClientsCreateRequest()
        if include_optional:
            return OauthClientsCreateRequest(
                name = 'My App',
    ...
    def testOauthClientsCreateRequest(self):
        """Test OauthClientsCreateRequest"""
