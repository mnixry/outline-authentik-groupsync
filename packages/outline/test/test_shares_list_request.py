...
class TestSharesListRequest(unittest.TestCase):
    """SharesListRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesListRequest:
        """Test SharesListRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesListRequest`
        """
        model = SharesListRequest()
        if include_optional:
            return SharesListRequest(
                offset = 0,
                limit = 25,
                sort = 'updatedAt',
                direction = 'DESC',
    ...
    def testSharesListRequest(self):
        """Test SharesListRequest"""
