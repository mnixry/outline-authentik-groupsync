...
class TestViewsCreate200Response(unittest.TestCase):
    """ViewsCreate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ViewsCreate200Response:
        """Test ViewsCreate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ViewsCreate200Response`
        """
        model = ViewsCreate200Response()
        if include_optional:
            return ViewsCreate200Response(
                data = outline_openapi.models.view.View(
                    id = '', 
                    document_id = '', 
    ...
    def testViewsCreate200Response(self):
        """Test ViewsCreate200Response"""
