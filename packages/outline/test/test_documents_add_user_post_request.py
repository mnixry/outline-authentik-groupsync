...
class TestDocumentsAddUserPostRequest(unittest.TestCase):
    """DocumentsAddUserPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsAddUserPostRequest:
        """Test DocumentsAddUserPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsAddUserPostRequest`
        """
        model = DocumentsAddUserPostRequest()
        if include_optional:
            return DocumentsAddUserPostRequest(
                id = '',
                user_id = '',
                permission = 'read'
            )
    ...
    def testDocumentsAddUserPostRequest(self):
        """Test DocumentsAddUserPostRequest"""
