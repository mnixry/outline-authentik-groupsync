...
class TestGroupsAddUser200ResponseData(unittest.TestCase):
    """GroupsAddUser200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsAddUser200ResponseData:
        """Test GroupsAddUser200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsAddUser200ResponseData`
        """
        model = GroupsAddUser200ResponseData()
        if include_optional:
            return GroupsAddUser200ResponseData(
                users = [
    ...
    def testGroupsAddUser200ResponseData(self):
        """Test GroupsAddUser200ResponseData"""
