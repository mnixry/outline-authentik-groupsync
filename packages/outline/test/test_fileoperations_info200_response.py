...
class TestFileoperationsInfo200Response(unittest.TestCase):
    """FileoperationsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileoperationsInfo200Response:
        """Test FileoperationsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileoperationsInfo200Response`
        """
        model = FileoperationsInfo200Response()
        if include_optional:
            return FileoperationsInfo200Response(
                data = outline_openapi.models.file_operation.FileOperation(
                    id = '', 
                    type = 'export', 
                    state = 'complete', 
                    collection = null, 
    ...
    def testFileoperationsInfo200Response(self):
        """Test FileoperationsInfo200Response"""
