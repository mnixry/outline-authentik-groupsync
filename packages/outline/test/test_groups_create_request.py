...
class TestGroupsCreateRequest(unittest.TestCase):
    """GroupsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupsCreateRequest:
        """Test GroupsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupsCreateRequest`
        """
        model = GroupsCreateRequest()
        if include_optional:
    ...
    def testGroupsCreateRequest(self):
        """Test GroupsCreateRequest"""
