...
class TestSharesCreateRequest(unittest.TestCase):
    """SharesCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesCreateRequest:
        """Test SharesCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesCreateRequest`
        """
        model = SharesCreateRequest()
        if include_optional:
            return SharesCreateRequest(
                document_id = ''
            )
        else:
            return SharesCreateRequest(
    ...
    def testSharesCreateRequest(self):
        """Test SharesCreateRequest"""
