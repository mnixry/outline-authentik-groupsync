...
class TestSharesInfo200Response(unittest.TestCase):
    """SharesInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesInfo200Response:
        """Test SharesInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesInfo200Response`
        """
        model = SharesInfo200Response()
        if include_optional:
            return SharesInfo200Response(
                data = outline_openapi.models.share.Share(
                    id = '', 
    ...
    def testSharesInfo200Response(self):
        """Test SharesInfo200Response"""
