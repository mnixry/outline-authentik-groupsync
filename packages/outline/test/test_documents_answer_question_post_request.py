...
class TestDocumentsAnswerQuestionPostRequest(unittest.TestCase):
    """DocumentsAnswerQuestionPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentsAnswerQuestionPostRequest:
        """Test DocumentsAnswerQuestionPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentsAnswerQuestionPostRequest`
        """
        model = DocumentsAnswerQuestionPostRequest()
        if include_optional:
            return DocumentsAnswerQuestionPostRequest(
    ...
    def testDocumentsAnswerQuestionPostRequest(self):
        """Test DocumentsAnswerQuestionPostRequest"""
