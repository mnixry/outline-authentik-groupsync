...
class TestUsersInvite200ResponseData(unittest.TestCase):
    """UsersInvite200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsersInvite200ResponseData:
        """Test UsersInvite200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsersInvite200ResponseData`
        """
        model = UsersInvite200ResponseData()
        if include_optional:
            return UsersInvite200ResponseData(
                sent = [
    ...
    def testUsersInvite200ResponseData(self):
        """Test UsersInvite200ResponseData"""
