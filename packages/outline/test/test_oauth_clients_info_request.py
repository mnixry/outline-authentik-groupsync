...
class TestOauthClientsInfoRequest(unittest.TestCase):
    """OauthClientsInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OauthClientsInfoRequest:
        """Test OauthClientsInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthClientsInfoRequest`
        """
        model = OauthClientsInfoRequest()
        if include_optional:
            return OauthClientsInfoRequest(
                id = '',
    ...
    def testOauthClientsInfoRequest(self):
        """Test OauthClientsInfoRequest"""
