...
class TestCollectionsCreateRequest(unittest.TestCase):
    """CollectionsCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsCreateRequest:
        """Test CollectionsCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsCreateRequest`
        """
        model = CollectionsCreateRequest()
        if include_optional:
    ...
    def testCollectionsCreateRequest(self):
        """Test CollectionsCreateRequest"""
