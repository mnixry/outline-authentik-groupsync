...
class TestSharesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_shares_create_post(self) -> None:
    ...
    async def test_shares_info_post(self) -> None:
    ...
    async def test_shares_list_post(self) -> None:
    ...
    async def test_shares_revoke_post(self) -> None:
    ...
    async def test_shares_update_post(self) -> None:
