...
class TestCollectionsInfo200Response(unittest.TestCase):
    """CollectionsInfo200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsInfo200Response:
        """Test CollectionsInfo200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsInfo200Response`
        """
        model = CollectionsInfo200Response()
        if include_optional:
            return CollectionsInfo200Response(
                data = outline_openapi.models.collection.Collection(
                    id = '', 
                    url_id = 'hDYep1TPAM', 
    ...
    def testCollectionsInfo200Response(self):
        """Test CollectionsInfo200Response"""
