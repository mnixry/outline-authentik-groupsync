...
class TestCollectionsMemberships200Response(unittest.TestCase):
    """CollectionsMemberships200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionsMemberships200Response:
        """Test CollectionsMemberships200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionsMemberships200Response`
        """
        model = CollectionsMemberships200Response()
        if include_optional:
            return CollectionsMemberships200Response(
                data = outline_openapi.models.collections_add_user_200_response_data.collectionsAddUser_200_response_data(
                    users = [
    ...
    def testCollectionsMemberships200Response(self):
        """Test CollectionsMemberships200Response"""
