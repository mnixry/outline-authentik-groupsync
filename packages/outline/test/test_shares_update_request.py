...
class TestSharesUpdateRequest(unittest.TestCase):
    """SharesUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SharesUpdateRequest:
        """Test SharesUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharesUpdateRequest`
        """
        model = SharesUpdateRequest()
        if include_optional:
            return SharesUpdateRequest(
                id = '',
                published = True
            )
        else:
    ...
    def testSharesUpdateRequest(self):
        """Test SharesUpdateRequest"""
