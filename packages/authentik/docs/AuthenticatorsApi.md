...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_sms_partial_update(id, patched_sms_device_request=patched_sms_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_sms_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_sms_update(id, sms_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_sms_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.authenticators_static_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_static_list(name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_static_partial_update(id, patched_static_device_request=patched_static_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_static_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_static_update(id, static_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_static_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.authenticators_totp_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_totp_list(name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_totp_partial_update(id, patched_totp_device_request=patched_totp_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_totp_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_totp_update(id, totp_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_totp_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.authenticators_webauthn_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_webauthn_list(name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_webauthn_partial_update(id, patched_web_authn_device_request=patched_web_authn_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_webauthn_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_webauthn_update(id, web_authn_device_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.authenticators_webauthn_used_by_list(id)
