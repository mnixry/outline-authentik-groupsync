...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.core_user_consent_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_user_consent_list(application=application, ordering=ordering, page=page, page_size=page_size, search=search, user=user)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_user_consent_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_user_consent_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_create(user_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.core_users_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.core_users_impersonate_end_retrieve()
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_me_retrieve()
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_partial_update(id, patched_user_request=patched_user_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_recovery_create(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.core_users_recovery_email_create(email_stage, id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_service_account_create(user_service_account_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.core_users_set_password_create(id, user_password_set_request)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_update(id, user_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.core_users_used_by_list(id)
