...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.oauth2_access_tokens_destroy(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_access_tokens_list(ordering=ordering, page=page, page_size=page_size, provider=provider, search=search, user=user)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_access_tokens_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_access_tokens_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.oauth2_authorization_codes_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_authorization_codes_list(ordering=ordering, page=page, page_size=page_size, provider=provider, search=search, user=user)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_authorization_codes_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_authorization_codes_used_by_list(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.oauth2_refresh_tokens_destroy(id)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_refresh_tokens_list(ordering=ordering, page=page, page_size=page_size, provider=provider, search=search, user=user)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_refresh_tokens_retrieve(id)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.oauth2_refresh_tokens_used_by_list(id)
