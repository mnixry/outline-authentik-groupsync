...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_openapi.PoliciesApi(api_client)
    policy_uuid = 'policy_uuid_example' # str | A UUID string identifying this GeoIP Policy.
    patched_geo_ip_policy_request = authentik_openapi.PatchedGeoIPPolicyRequest() # PatchedGeoIPPolicyRequest |  (optional)

    try:
        api_response = await api_instance.policies_geoip_partial_update(policy_uuid, patched_geo_ip_policy_request=patched_geo_ip_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_geoip_retrieve(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_geoip_update(policy_uuid, geo_ip_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_geoip_used_by_list(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_create(password_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.policies_password_destroy(policy_uuid)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_create(password_expiry_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.policies_password_expiry_destroy(policy_uuid)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_list(created=created, days=days, deny_only=deny_only, execution_logging=execution_logging, last_updated=last_updated, name=name, ordering=ordering, page=page, page_size=page_size, policy_uuid=policy_uuid, search=search)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_partial_update(policy_uuid, patched_password_expiry_policy_request=patched_password_expiry_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_retrieve(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_update(policy_uuid, password_expiry_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_expiry_used_by_list(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_list(amount_digits=amount_digits, amount_lowercase=amount_lowercase, amount_symbols=amount_symbols, amount_uppercase=amount_uppercase, check_have_i_been_pwned=check_have_i_been_pwned, check_static_rules=check_static_rules, check_zxcvbn=check_zxcvbn, created=created, error_message=error_message, execution_logging=execution_logging, hibp_allowed_count=hibp_allowed_count, last_updated=last_updated, length_min=length_min, name=name, ordering=ordering, page=page, page_size=page_size, password_field=password_field, policy_uuid=policy_uuid, search=search, symbol_charset=symbol_charset, zxcvbn_score_threshold=zxcvbn_score_threshold)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_partial_update(policy_uuid, patched_password_policy_request=patched_password_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_retrieve(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_update(policy_uuid, password_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_password_used_by_list(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_create(reputation_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.policies_reputation_destroy(policy_uuid)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_list(check_ip=check_ip, check_username=check_username, created=created, execution_logging=execution_logging, last_updated=last_updated, name=name, ordering=ordering, page=page, page_size=page_size, policy_uuid=policy_uuid, search=search, threshold=threshold)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_partial_update(policy_uuid, patched_reputation_policy_request=patched_reputation_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_retrieve(policy_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.policies_reputation_scores_destroy(reputation_uuid)
    except Exception as e:
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_scores_list(identifier=identifier, identifier_in=identifier_in, ip=ip, ordering=ordering, page=page, page_size=page_size, score=score, search=search)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_scores_retrieve(reputation_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_scores_used_by_list(reputation_uuid)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_update(policy_uuid, reputation_policy_request)
...
async with authentik_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.policies_reputation_used_by_list(policy_uuid)
