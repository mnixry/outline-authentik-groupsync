...
class PatchedPasswordStageRequest(Model):
    ...
    def __init__(self, name: str=None, flow_set: List[FlowSetRequest]=None, backends: List[BackendsEnum]=None, configure_flow: str=None, failed_attempts_before_cancel: int=None, allow_show_password: bool=None):
        """PatchedPasswordStageRequest - a model defined in OpenAPI

        :param name: The name of this PatchedPasswordStageRequest.
        :param flow_set: The flow_set of this PatchedPasswordStageRequest.
        :param backends: The backends of this PatchedPasswordStageRequest.
        :param configure_flow: The configure_flow of this PatchedPasswordStageRequest.
        :param failed_attempts_before_cancel: The failed_attempts_before_cancel of this PatchedPasswordStageRequest.
        :param allow_show_password: The allow_show_password of this PatchedPasswordStageRequest.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PatchedPasswordStageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PatchedPasswordStageRequest of this PatchedPasswordStageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this PatchedPasswordStageRequest.


        :return: The name of this PatchedPasswordStageRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatchedPasswordStageRequest.
    ...
    @property
    def flow_set(self):
        """Gets the flow_set of this PatchedPasswordStageRequest.


        :return: The flow_set of this PatchedPasswordStageRequest.
    ...
    def flow_set(self, flow_set):
        """Sets the flow_set of this PatchedPasswordStageRequest.
    ...
    @property
    def backends(self):
        """Gets the backends of this PatchedPasswordStageRequest.

        Selection of backends to test the password against.

        :return: The backends of this PatchedPasswordStageRequest.
    ...
    def backends(self, backends):
        """Sets the backends of this PatchedPasswordStageRequest.
    ...
    def configure_flow(self):
        """Gets the configure_flow of this PatchedPasswordStageRequest.

        Flow used by an authenticated user to configure this Stage. If empty, user will not be able to configure this stage.

        :return: The configure_flow of this PatchedPasswordStageRequest.
        :rtype: str
        """
    ...
    def configure_flow(self, configure_flow):
        """Sets the configure_flow of this PatchedPasswordStageRequest.
    ...
    def failed_attempts_before_cancel(self):
        """Gets the failed_attempts_before_cancel of this PatchedPasswordStageRequest.

        How many attempts a user has before the flow is canceled. To lock the user out, use a reputation policy and a user_write stage.

        :return: The failed_attempts_before_cancel of this PatchedPasswordStageRequest.
        :rtype: int
        """
    ...
    def failed_attempts_before_cancel(self, failed_attempts_before_cancel):
        """Sets the failed_attempts_before_cancel of this PatchedPasswordStageRequest.
    ...
    def allow_show_password(self):
        """Gets the allow_show_password of this PatchedPasswordStageRequest.

        When enabled, provides a 'show password' button with the password input field.

        :return: The allow_show_password of this PatchedPasswordStageRequest.
        :rtype: bool
        """
    ...
    def allow_show_password(self, allow_show_password):
        """Sets the allow_show_password of this PatchedPasswordStageRequest.
