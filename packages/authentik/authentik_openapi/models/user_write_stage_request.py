...
class UserWriteStageRequest(Model):
    ...
    def __init__(self, name: str=None, flow_set: List[FlowSetRequest]=None, user_creation_mode: UserCreationModeEnum=None, create_users_as_inactive: bool=None, create_users_group: str=None, user_type: UserTypeEnum=None, user_path_template: str=None):
        """UserWriteStageRequest - a model defined in OpenAPI

        :param name: The name of this UserWriteStageRequest.
        :param flow_set: The flow_set of this UserWriteStageRequest.
        :param user_creation_mode: The user_creation_mode of this UserWriteStageRequest.
        :param create_users_as_inactive: The create_users_as_inactive of this UserWriteStageRequest.
        :param create_users_group: The create_users_group of this UserWriteStageRequest.
        :param user_type: The user_type of this UserWriteStageRequest.
        :param user_path_template: The user_path_template of this UserWriteStageRequest.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserWriteStageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserWriteStageRequest of this UserWriteStageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this UserWriteStageRequest.


        :return: The name of this UserWriteStageRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UserWriteStageRequest.
    ...
    @property
    def flow_set(self):
        """Gets the flow_set of this UserWriteStageRequest.


        :return: The flow_set of this UserWriteStageRequest.
    ...
    def flow_set(self, flow_set):
        """Sets the flow_set of this UserWriteStageRequest.
    ...
    def user_creation_mode(self):
        """Gets the user_creation_mode of this UserWriteStageRequest.


        :return: The user_creation_mode of this UserWriteStageRequest.
    ...
    def user_creation_mode(self, user_creation_mode):
        """Sets the user_creation_mode of this UserWriteStageRequest.
    ...
    def create_users_as_inactive(self):
        """Gets the create_users_as_inactive of this UserWriteStageRequest.

        When set, newly created users are inactive and cannot login.

        :return: The create_users_as_inactive of this UserWriteStageRequest.
        :rtype: bool
        """
    ...
    def create_users_as_inactive(self, create_users_as_inactive):
        """Sets the create_users_as_inactive of this UserWriteStageRequest.
    ...
    def create_users_group(self):
        """Gets the create_users_group of this UserWriteStageRequest.

        Optionally add newly created users to this group.

        :return: The create_users_group of this UserWriteStageRequest.
        :rtype: str
        """
    ...
    def create_users_group(self, create_users_group):
        """Sets the create_users_group of this UserWriteStageRequest.
    ...
    @property
    def user_type(self):
        """Gets the user_type of this UserWriteStageRequest.


        :return: The user_type of this UserWriteStageRequest.
        :rtype: UserTypeEnum
        """
    ...
    def user_type(self, user_type):
        """Sets the user_type of this UserWriteStageRequest.
    ...
    def user_path_template(self):
        """Gets the user_path_template of this UserWriteStageRequest.


        :return: The user_path_template of this UserWriteStageRequest.
        :rtype: str
        """
    ...
    def user_path_template(self, user_path_template):
        """Sets the user_path_template of this UserWriteStageRequest.
