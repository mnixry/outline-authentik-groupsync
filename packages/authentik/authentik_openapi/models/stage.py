...
class Stage(Model):
    ...
    def __init__(self, pk: str=None, name: str=None, component: str=None, verbose_name: str=None, verbose_name_plural: str=None, meta_model_name: str=None, flow_set: List[FlowSet]=None):
        ...
        :param pk: The pk of this Stage.
        :param name: The name of this Stage.
        :param component: The component of this Stage.
        :param verbose_name: The verbose_name of this Stage.
        :param verbose_name_plural: The verbose_name_plural of this Stage.
        :param meta_model_name: The meta_model_name of this Stage.
        :param flow_set: The flow_set of this Stage.
        """
        self.openapi_types = {
            'pk': str,
            'name': str,
    ...
    @property
    def pk(self):
        """Gets the pk of this Stage.


        :return: The pk of this Stage.
        :rtype: str
        """
        return self._pk
    ...
    @property
    def component(self):
        """Gets the component of this Stage.

        Get object type so that we know how to edit the object

        :return: The component of this Stage.
        :rtype: str
        """
    ...
    def component(self, component):
        """Sets the component of this Stage.
    ...
    def verbose_name(self):
        """Gets the verbose_name of this Stage.

        Return object's verbose_name

        :return: The verbose_name of this Stage.
        :rtype: str
        """
    ...
    def verbose_name(self, verbose_name):
        """Sets the verbose_name of this Stage.
    ...
    def verbose_name_plural(self):
        """Gets the verbose_name_plural of this Stage.

        Return object's plural verbose_name

        :return: The verbose_name_plural of this Stage.
        :rtype: str
        """
    ...
    def verbose_name_plural(self, verbose_name_plural):
        """Sets the verbose_name_plural of this Stage.
    ...
    def meta_model_name(self):
        """Gets the meta_model_name of this Stage.

        Return internal model name

        :return: The meta_model_name of this Stage.
        :rtype: str
        """
    ...
    def meta_model_name(self, meta_model_name):
        """Sets the meta_model_name of this Stage.
    ...
    @property
    def flow_set(self):
        """Gets the flow_set of this Stage.


        :return: The flow_set of this Stage.
        :rtype: List[FlowSet]
        """
    ...
    def flow_set(self, flow_set):
        """Sets the flow_set of this Stage.
