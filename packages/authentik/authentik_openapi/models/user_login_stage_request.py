...
class UserLoginStageRequest(Model):
    ...
    def __init__(self, name: str=None, flow_set: List[FlowSetRequest]=None, session_duration: str=None, terminate_other_sessions: bool=None, remember_me_offset: str=None, network_binding: NetworkBindingEnum=None, geoip_binding: GeoipBindingEnum=None):
        """UserLoginStageRequest - a model defined in OpenAPI

        :param name: The name of this UserLoginStageRequest.
        :param flow_set: The flow_set of this UserLoginStageRequest.
        :param session_duration: The session_duration of this UserLoginStageRequest.
        :param terminate_other_sessions: The terminate_other_sessions of this UserLoginStageRequest.
        :param remember_me_offset: The remember_me_offset of this UserLoginStageRequest.
        :param network_binding: The network_binding of this UserLoginStageRequest.
        :param geoip_binding: The geoip_binding of this UserLoginStageRequest.
        """
        self.openapi_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UserLoginStageRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UserLoginStageRequest of this UserLoginStageRequest.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def name(self):
        """Gets the name of this UserLoginStageRequest.


        :return: The name of this UserLoginStageRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UserLoginStageRequest.
    ...
    @property
    def flow_set(self):
        """Gets the flow_set of this UserLoginStageRequest.


        :return: The flow_set of this UserLoginStageRequest.
    ...
    def flow_set(self, flow_set):
        """Sets the flow_set of this UserLoginStageRequest.
    ...
    def session_duration(self):
        """Gets the session_duration of this UserLoginStageRequest.

        Determines how long a session lasts. Default of 0 means that the sessions lasts until the browser is closed. (Format: hours=-1;minutes=-2;seconds=-3)

        :return: The session_duration of this UserLoginStageRequest.
        :rtype: str
        """
    ...
    def session_duration(self, session_duration):
        """Sets the session_duration of this UserLoginStageRequest.
    ...
    def terminate_other_sessions(self):
        """Gets the terminate_other_sessions of this UserLoginStageRequest.

        Terminate all other sessions of the user logging in.

        :return: The terminate_other_sessions of this UserLoginStageRequest.
        :rtype: bool
        """
    ...
    def terminate_other_sessions(self, terminate_other_sessions):
        """Sets the terminate_other_sessions of this UserLoginStageRequest.
    ...
    def remember_me_offset(self):
        """Gets the remember_me_offset of this UserLoginStageRequest.
        ...
        :return: The remember_me_offset of this UserLoginStageRequest.
        :rtype: str
        """
    ...
    def remember_me_offset(self, remember_me_offset):
        """Sets the remember_me_offset of this UserLoginStageRequest.
    ...
    def network_binding(self):
        """Gets the network_binding of this UserLoginStageRequest.

        Bind sessions created by this stage to the configured network

        :return: The network_binding of this UserLoginStageRequest.
    ...
    def network_binding(self, network_binding):
        """Sets the network_binding of this UserLoginStageRequest.
    ...
    def geoip_binding(self):
        """Gets the geoip_binding of this UserLoginStageRequest.

        Bind sessions created by this stage to the configured GeoIP location

        :return: The geoip_binding of this UserLoginStageRequest.
    ...
    def geoip_binding(self, geoip_binding):
        """Sets the geoip_binding of this UserLoginStageRequest.
